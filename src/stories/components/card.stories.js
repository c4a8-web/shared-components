...
export default {
  ...
  argTypes: {
    ...
    product: {
      description:
        "Product Variant of Cards, Includes Subpoints e.g. Tenant/Contacts/Other",
      type: "array",
    },
    tag: {
...
export const BlogPost = {
  args: {
    ...
    blogtitlepic: "path/to/blog_image/head-emergency-calls",
    socialimg:
      "https://res.cloudinary.com/glueckkanja/image/upload/v1620393502/blog/heads/head-emergency-calls.jpg",
    excerpt:
...
export const BlogPostLarge = {
  args: {
    ...
    layout: "post",
    title:
      "Azure Virtual Desktop – Ja, aber automatisiert bitte! Lorem ipsum dolor sit",
    moment: "2021-05-11",
