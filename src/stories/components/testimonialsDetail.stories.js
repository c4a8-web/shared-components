import TestimonialsDetailComponent from "../../components/testimonials-detail";

export default {
  title: "Components/Testimonials Detail",
  component: TestimonialsDetailComponent,
};
...
export const TestimonialsDetailColor = {
  args: {
    ...baseArgs,
    description:
      "<p>Weit hinten, hinter den Wortbergen, fern der Länder Vokalien und Konsonantien leben die Blindtexte. Abgeschieden wohnen sie in Buchstabhausen an der Küste des Semantik, eines großen Sprachozeans.</p> ",
...
export const TestimonialsDetailSafety = {
  args: {
    name: "Matti Puolitaival",
    title: "Senior Consultant Azure",
    image: {
