  ...
  methods: {
    ...
    updateBlocks() {
      ...
      if (
        ...
        this.scrollDistancePercentage <= minPercentage
      )
        return this.resetIsScrolledUpOut();

      if (
        !this.isScrolledDownOut &&
        this.scrollDistancePercentage >= maxPercentage
      )
    ...
    calcScrollDistancePercentage() {
      ...
      if (scrollPosition >= componentTop) {
        ...
        scrollDistancePercentage =
          (scrolledPastComponent / componentHeightHalf) * 100;
      }
    ...
    calcBlockStyle(index) {
      return [
        {
          "--content-scroller-block-scroll-percentage":
            this.blockScrollPercentage[index],
        },
      ];
    },
    calcMinHeight() {
