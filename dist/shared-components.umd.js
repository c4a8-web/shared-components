(function(g,n){typeof exports=="object"&&typeof module<"u"?module.exports=n(require("vue")):typeof define=="function"&&define.amd?define(["vue"],n):(g=typeof globalThis<"u"?globalThis:g||self,g.SharedComponents=n(g.Vue))})(this,function(g){"use strict";var pi=Object.defineProperty;var ui=(g,n,l)=>n in g?pi(g,n,{enumerable:!0,configurable:!0,writable:!0,value:l}):g[n]=l;var p=(g,n,l)=>ui(g,typeof n!="symbol"?n+"":n,l);var b;const m=class m{static isInViewportPercent(e,s){const i=e.getBoundingClientRect(),r=window.innerHeight||document.documentElement.clientHeight,a=window.innerWidth||document.documentElement.clientWidth,o={x:i.x,y:i.y,width:i.width,height:i.height},c={x:0,y:0,width:a,height:r},d=o.width*o.height,h=m.intersection(o,c);return s<=h/d*100}static getScrollTop(e){if(!e)return;const s=document.querySelector("header"),i=s?(s==null?void 0:s.offsetHeight)+40:0;return e.getBoundingClientRect().top-i+window.scrollY}static scrollIntoView(e,s){e&&window.scrollTo({top:m.getScrollTop(e),behavior:s?"smooth":"auto"})}static getLang(){return(document.querySelector("html").getAttribute("lang")||defaultLang).toLowerCase()}static isNotDefaultLang(){return this.getLang()!==this.defaultLang}static scrollToTop(){m.scrollIntoView(document.querySelector("body"),!0)}static getParentComponent(e){return m.getParent(e,".is-component")}static getParent(e,s){var r;const i=e.parentNode;return i===null||i.tagName==="body"?null:(r=i.parentNode)!=null&&r.querySelector(s)?i:m.getParent(i,s)}static append(e,s){if(e){const i=document.createElement("div");i.innerHTML=s!=null&&s.nodeType?s.outerHTML:s;const r=i==null?void 0:i.children[0];if(r)return e.appendChild(r)}return null}static replace(e,s){e&&s&&(e.innerHTML=s.innerHTML)}static generateUrl(e,s,i){let r;return e&&s&&(r=e.toLowerCase().replace(/\s/g,"-").replace(/[&\/\\#,+()$~%.'":*?<>{}!]/g,"").replace(/\u00dc/,"ue").replace(/\u00c4/,"ae").replace(/\u00d6/,"oe").replace(/\u00fc/,"ue").replace(/\u00e4/,"ae").replace(/\u00f6/,"oe").replace(/\u00df/,"ss"),r=s+m.urlSeperator+r.replace(/-+$/,"")+"-"+i),r}static toBase64(e){return new Promise((s,i)=>{const r=new FileReader;r.readAsDataURL(e),r.onload=()=>{const a=r.result.split(",")[1];s(a)},r.onerror=a=>i(a)})}static toSize(e){const s=["Bytes","KB","MB","GB","TB"];if(e==0)return"0 Byte";const i=parseInt(Math.floor(Math.log(e)/Math.log(1024)));return(e/Math.pow(1024,i)).toFixed(1)+" "+s[i]}static camalCaseToSnakeCase(e){return e.replace(/[A-Z]/g,s=>`_${s.toLowerCase()}`)}static animateValue(e,s,i,r,a=m.priceFormatter){let o=null;const c=d=>{o||(o=d);const h=Math.min((d-o)/r,1),u=h*(i-s)+s,y=a.format(u);e.innerHTML=y,h<1&&window.requestAnimationFrame(c)};window.requestAnimationFrame(c)}static isOutsideOf(e,s){const i=s.composedPath?s.composedPath():s.path;return i?!i.some(r=>r.className&&r.className.includes&&r.className.includes(e)):!1}static getExtension(e){return e.split(".").pop()}static validateVueProps(e){var a;const s=(a=e==null?void 0:e.$)==null?void 0:a.propsOptions[0],i=e==null?void 0:e.$props,r={props:{}};return Object.keys(i).map(o=>{let c=i[o];c===""&&(c=s[o].default),r.props[o]=c}),r}static isTrue(e){return e===!0||e==="true"}static capitalize(e){return e.charAt(0).toUpperCase()+e.slice(1)}static sleep(e){return new Promise(s=>setTimeout(s,e))}static randomRange(e,s){return Math.floor(Math.random()*(s-e+1)+e)}static uuid(){const e=Date.now().toString(16)+Math.random().toString(4)+"0".repeat(16),s=m.randomRange(0,8),i=m.randomRange(0,16);return"u"+[e.substring(s,s+8),e.substring(i,i+4)].join("-").replaceAll(".","9")}static getBreakpoint(){return getComputedStyle(document.body).getPropertyValue("--breakpoint").trim()}static isBelowBreakpoint(e){let s=["xs","sm","md","lg","xl","xxl"];const i=m.getBreakpoint();return s.indexOf(e)>=s.indexOf(i)}static isUpperBreakpoint(){return!m.isBelowBreakpoint("md")}static getYoutubeThumbnail(e){let s;const i=e.match(/youtube\.com.*(\?v=|vi=|\/live\/)(.{11})/),r=e.match(/youtu\.be\/(.{11})/);return i?s=i[2]:r&&(s=r[1]),`https://i1.ytimg.com/vi/${s}/maxresdefault.jpg`}static truncateWords(e,s){if(!e)return;const i=e.split(" "),r=i.slice(0,s).join(" ");return i.length>s?r+" ...":r}static stripHtml(e){if(e)return e.replace(new RegExp(/<.*?>/g),"")}static isGermanDate(e){return!!e.match(/^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d$/)}static isStorybook(){return window.STORYBOOK_ENV==="HTML"}static isTestingStorybook(){return document.location.pathname.indexOf(m.storybookPath)!==-1}static getSiteAssetPath(e){return m.isTestingStorybook()?`${m.storybookPath}${e}`:e}static getAssetPath(e){return m.isStorybook()?`../assets/${e}`:`/_includes/shared-components/assets/${e}`}static findRecursive(e,s,i){let r=!1,a,o,c;function d(h,u,y,M){if(!r){if(u(h,o)){r=!0,a=M(h,y);return}for(let q in h)typeof h[q]=="object"&&(h===c&&(o=q),d(h[q],u,h,M))}}return c=e,d(e,s,e,i),a}static storageSave(e,s,i=!0){localStorage.setItem(m.storagePrefix+e,i?JSON.stringify(s):s)}static storageGet(e){return localStorage.getItem(m.storagePrefix+e)}static getJSON(e){var s;if(e&&typeof e=="object"&&((s=Object.keys(e))==null?void 0:s.length)>0)return e;if(e&&typeof e=="string")try{return JSON.parse(e)}catch{console.error("Error parsing JSON:",e);return}}static getElementBgColor(e){if(!e||e.nodeType!==Node.ELEMENT_NODE)return;const s=window.getComputedStyle(e).backgroundColor;return s==="rgba(0, 0, 0, 0)"?null:s}static isValidTimeFormat(e){return/^(\d{1,2}(:\d{2})?-\d{1,2}(:\d{2})? Uhr)$/.test(e)}static standardizeTimeFormat(e){if(!this.isValidTimeFormat(e))return e;const s="Uhr";let i=e.split("-"),r=i[0].trim();r.includes(":")||(r+=":00"),r.length===4&&(r="0"+r);let a=i[1].trim().replace(` ${s}`,"");return a.includes(":")||(a+=":00"),a.length===4&&(a="0"+a),`${r} - ${a} ${s}`}static convertToDate(e){const s=e.match(/^(\d{1,2})\.-\d{1,2}\.(\d{1,2})\.(\d{4})$/);if(s){const r=parseInt(s[1],10),a=parseInt(s[2],10)-1,o=parseInt(s[3],10);return new Date(o,a,r)}return null}static XMLtoJSON(e){let s={};if(e.nodeType===Node.ELEMENT_NODE){if(e.attributes.length>0){s["@attributes"]={};for(let i=0;i<e.attributes.length;i++){const r=e.attributes.item(i);s["@attributes"][r.nodeName]=r.nodeValue}}}else(e.nodeType===Node.TEXT_NODE||e.nodeType===Node.CDATA_SECTION_NODE)&&(s=e.nodeValue);if(e.hasChildNodes())for(let i=0;i<e.childNodes.length;i++){const r=e.childNodes.item(i),a=r.nodeName;if(typeof s[a]>"u")s[a]=this.XMLtoJSON(r);else{if(typeof s[a].push>"u"){const o=s[a];s[a]=[],s[a].push(o)}s[a].push(this.XMLtoJSON(r))}}return s}static hasFontSizeClass(e){return e.indexOf("-font-size")!==-1||e.indexOf("font-size-")!==-1}static red(e){return parseInt(e.substring(1,3),16)}static green(e){return parseInt(e.substring(3,5),16)}static blue(e){return parseInt(e.substring(5,7),16)}static hexToRgb(e){let s;if(e.startsWith("--")||e.startsWith("var(")){const c=e.replace(/--|var\(/,"").replace(/\)$/,"");s=getComputedStyle(document.documentElement).getPropertyValue(c).trim()}const i=s||e,r=m.red(i),a=m.green(i),o=m.blue(i);return`${r}, ${a}, ${o}`}static getHash(){return window.location.hash}};p(m,"defaultLang","de"),p(m,"urlSeperator","#"),p(m,"priceFormatter",new Intl.NumberFormat("de-DE",{style:"decimal",maximumFractionDigits:0})),p(m,"storagePrefix","@gab_"),p(m,"storybookPath","/shared-components"),p(m,"decodeHTML",e=>new DOMParser().parseFromString(e,"text/html").documentElement.textContent),p(m,"intersection",(e,s)=>{const i=Math.max(0,Math.min(e.x+e.width,s.x+s.width)-Math.max(e.x,s.x)),r=Math.max(0,Math.min(e.y+e.height,s.y+s.height)-Math.max(e.y,s.y));return i*r}),p(m,"debounce",function(e,s,i){let r;return function(){const a=this,o=arguments;var c=function(){r=null,i||e.apply(a,o)},d=i&&!r;clearTimeout(r),r=setTimeout(c,s),d&&e.apply(a,o)}});let n=m;const l={ACTIVE:"active",READY:"is-ready",ERROR:"is-invalid",VALID:"is-valid",SUCCESS:"is-successful",HAS_ERROR:"has-error",HOVERING:"is-hovering",DRAGGING:"is-dragging",HIDDEN:"d-none",INVISIBLE:"is-invisible",EXPANDED:"is-expanded",EXPANDABLE:"is-expandable",OFF_SCREEN:"is-off-screen",COLLAPSED:"is-collapsed",IS_COLLAPSING:"is-collapsing",SHOW:"show",FADE:"fade",INITIALIZED:"is-initialized",LOADING:"is-loading",HIDE_LOADING:"hide-loading",END:"is-end",IS_SCROLLED:"is-scrolled",MODAL_OPEN:"modal--open",HAS_BACKGROUND:"has-background",IS_FULL:"is-full",STICKY:"is-sticky",IN_TRANSITION:"in-transition",IS_STARTING:"is-starting"},Oe=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"accordion",computed:{imageWrapperClasses(){return["accordion__floating-image-wrapper",n.isTrue(this.shadowless)===!0?null:"drop-shadow"]},containerClasses(){return["accordion__container utility-animation container vue-component",this.spacing,this.accordion.image?"accordion--has-image":null]},accordionClasses(){return["accordion utility-animation container mt-6 mb-4 my-lg-8 vue-component",this.accordion.image?"accordion--has-image":null]},fallbackImageClasses(){return["accordion__fallback-image-wrapper",n.isTrue(this.shadowless)===!0?null:"drop-shadow",this.showOutsideImage?l.SHOW:null]},columnClasses(){return["col",n.isTrue(this.left)?null:"text-center"]},headlineClasses(){var t;return`accordion__headline  ${(t=this.accordion)==null?void 0:t.headlineClasses}`}},mounted(){this.accordion.tabs&&(this.selectFallbackImage(),this.isUpperBreakpoint()?this.changeOutsideImage():this.outsideImage=this.fallbackImage,this.accordion.tabs.forEach(t=>{this.states.push(!!t.expanded)}))},methods:{isUpperBreakpoint(){return!n.isBelowBreakpoint("md")},selectFallbackImage(){if(!this.fallbackImage){const t=this.getActiveTab();this.fallbackImage=this.accordion.image||(t==null?void 0:t.image),this.fallbackAnimated=this.accordion.image?this.accordion.animated:t.animated}},getActiveTab(){var e;const t=(e=this.accordion)==null?void 0:e.tabs.filter(s=>s.expanded);return t?t[0]:null},handleClick(t){const e=this.states[t];this.states=this.states.map(s=>!1),this.states[t]=!e,this.isUpperBreakpoint()&&this.changeOutsideImage(t),this.allTabsClosed()&&this.changeToFallbackImage()},changeToFallbackImage(){this.showOutsideImage=!0,this.accordion.image=this.fallbackImage,this.outsideImage=this.fallbackImage,this.outsideAnimated=this.fallbackAnimated},changeOutsideImage(t){const e=this.getTabByIndex(t);this.showOutsideImage=!0,this.outsideImage=(e==null?void 0:e.image)||this.fallbackImage,this.outsideAnimated=e!=null&&e.image?e.animated:this.fallbackAnimated},getTabByIndex(t){var e;return typeof t>"u"?this.getActiveTab():(e=this.accordion)==null?void 0:e.tabs[t]},allTabsClosed(){return this.states.filter(t=>t===!0).length===0},getStateByIndex(t){return this.states[t]},getId(t,e,s){return`${s}${t.id}${e}`},isExpanded(t){return t.expanded?"true":"false"},buttonClasses(t){return["accordion__btn btn btn-link btn-block d-flex justify-content-between",t.expanded?null:"collapsed"]},contentClasses(t){return["accordion__content collapse position-static",t.expanded?"show":null]},cardClasses(t){return["accordion__card",this.getStateByIndex(t)?l.EXPANDED:null]},cardStyle(t){return`--utility-animation-index: ${t}`},accordionId(t){return`#${t.id}`},cloudinary(t){return t.cloudinary||!0},getImage(t){return t.image?t.image:this.accordion.image?this.accordion.image:null},getTab(t){return t.image?t:this.accordion}},data(){return{showOutsideImage:!1,outsideImage:!1,outsideAnimated:!1,states:[],fallbackImage:!1,fallbackAnimated:!1}},props:{accordion:Object,shadowless:{default:null},left:{default:null},spacing:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),f={REFRESH_ANIMATE_NUMBERS:"refresh-animate-numbers",FAB_BUTTON_CLOSE:"fab-button-close",FORM_AJAX_SUBMIT:"form-ajax-submit",FORM_RESET:"form-reset",FORM_ATTACHMENT_ERROR:"form-attachment-error",CHILD_HAS_UPDATE:"child-has-update",AD_BLOCK_INFO:"ad-block-info",DIMENSIONS_CHANGED:"dimensions-changed",SCROLL_UPDATE:"scroll-update",WINDOW_RESIZE:"window-resize",OPEN_MODAL:"open-modal",LOAD_MODAL:"load-modal",DROPDOWN_CHANGED:"dropdown-changed",DROPDOWN_OPENED:"dropdown-opened",CARD_TAG_CLICKED:"card-tag-clicked",ENDED:"ended"},w=class w{constructor(e,s){var i;e&&(this.root=e,this.options=s,(i=this.options)!=null&&i.noInit||this.root.classList.add(l.INITIALIZED))}static getInstancesKey(){return this.rootSelector.substring(1)}static expose(e){window[w.namespacePrefix]||(window[w.namespacePrefix]={});const s=this.getInstancesKey();window[w.namespacePrefix][s]||(window[w.namespacePrefix][s]=[]),window[w.namespacePrefix][s].push(e)}static getInstance(e){const i=window[w.namespacePrefix][this.getInstancesKey()].filter(r=>(r==null?void 0:r.root)===e);return i?i[0]:null}static initElement(e,s){const i=new this(e,s);return this.instances.push(i),this.expose(i),i}static init(e){this.instances=[];const s=e||document,i=`${this.rootSelector}:not(.${l.INITIALIZED})`;[].forEach.call(s.querySelectorAll(i),r=>{this.initElement(r)})}};p(w,"rootSelector",""),p(w,"instances",[]),p(w,"namespacePrefix","baseComponents");let Q=w;class F{}p(F,"rootSelector",".form-attachments"),p(F,"base64Selector",".form-attachments__base64");let ee=(b=class extends Q{constructor(e,s){var i;super(e,s),e&&(this.root=e,this.formSelector=".form__form",this.gotchaSelector=".form__super-field",this.attachmentSelector='input[type="file"][required]',this.subjectSelector='input[name="_subject"]',this.companySelector='input[id="company"]',this.form=e.querySelector(this.formSelector),this.subject=e.querySelector(this.subjectSelector),this.company=e.querySelector(this.companySelector),this.groups={},this.minLengthOther=1,this.options=s,this.addCustomValidationRules(),this.updateGotcha(),this.addValidation(),this.form&&this.subject&&this.hasUrlParameter()&&this.prefillFormValues(),(i=this.options)!=null&&i.noEvents?this.isCompanyForm()&&this.addSubjectListener():this.bindEvents())}addCustomValidationRules(){window.$&&$.validator&&($.validator.methods.email=function(e,s){return this.optional(s)||b.regularExpression.test(e)})}isCompanyForm(){return!!(this.form&&this.subject&&this.company)}hasUrlParameter(){if(window.location.search!=="")return!0}prefillFormValues(){const e=new URLSearchParams(window.location.search);for(const[s,i]of e.entries())this.prefillFormValue(s,i)}prefillFormValue(e,s){const i=this.form;if(!i)return;const r=i.querySelector(`input[name="${e}"],textarea[name="${e}"]`);r&&(r.value=s)}hasCustomValidation(){return this.root.classList.contains("form--custom-validation")}hasAjaxSubmit(){return this.root.classList.contains("form--ajax")}bindEvents(){(Object.keys(this.groups).length||this.hasCustomValidation()||this.hasAjaxSubmit()||this.isCompanyForm())&&(this.form.addEventListener("submit",this.handleSubmit.bind(this)),this.form.addEventListener("reset",this.handleReset.bind(this)))}addSubjectListener(){this.form.addEventListener("submit",this.handleSubmit.bind(this))}handleReset(){b.reset(this.form)}static reset(e){!e||!e.reset||(e.reset(),[].forEach.call(e.querySelectorAll(`.${l.VALID}`),s=>{s.classList.remove(l.VALID)}),[].forEach.call(e.querySelectorAll(`.${l.ERROR}`),s=>{s.classList.remove(l.ERROR)}))}handleSubmit(e){this.validate(e)&&this.submit(e)}updateSubject(){!this.subject||!this.company||(this.subject.value=this.subject.value+": "+this.company.value)}submit(e){e.stopImmediatePropagation(),e.preventDefault(),this.updateSubject(),this.customSubmit?this.customSubmit(e):this.hasAjaxSubmit()?this.ajaxSubmit():this.form.submit()}static getId(e){return n.uuid()+this.delimiter+e}static getName(e){if(e.includes(this.delimiter)){const s=e.indexOf(this.delimiter);return e.slice(s+this.delimiter.length)}return e}static getFormData(e){const s=new FormData(e),i=[];for(let r of s)i.push(encodeURIComponent(r[0])+"="+encodeURIComponent(r[1]));return i.join("&")}ajaxSubmit(){const e=b.getFormData(this.form);fetch(this.form.action,{method:this.form.method||"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},redirect:"follow",body:e}).then(s=>{(s.status===200||s.status===302)&&this.ajaxSubmitCompleted()})}ajaxSubmitCompleted(){document.dispatchEvent(new CustomEvent(f.FORM_AJAX_SUBMIT,{detail:{target:this.root}}))}triggerExternalValidation(){let e=!1;if(window.$){const s=$(this.form);if(typeof s.validate!="function")return console.error("form.validate is not a function"),!0;e=s.validate().form()}return e}validate(e){let s=this.triggerExternalValidation();return(!this.isValid(e)||s===!1)&&(e.stopImmediatePropagation(),e.preventDefault(),s=!1),s}isValid(e){e.stopImmediatePropagation();let s=!0,i=!0;this.hasAttachments()&&(s=this.validateAttachments());for(const[r,a]of Object.entries(this.groups))this.isValidGroup(a)||(s=!1,this.addGroupError(a,i),i=!1);return s}validateAttachments(){let e=!0;return[].forEach.call(this.form.querySelectorAll(F.base64Selector),s=>{s.value||(e=!1)}),e||(e=!0,[].forEach.call(this.form.querySelectorAll(this.attachmentSelector),s=>{s.files.length===0&&(e=!1,this.addAttachmentError(s))}),e)}addAttachmentError(e){const s=n.getParent(e,F.rootSelector);s!==null&&s.classList.add(l.HAS_ERROR)}hasAttachments(){return this.form.querySelector(this.attachmentSelector)}addGroupError(e,s){for(let i=0;i<e.length;i++){const r=this.getGroupParent(e[i]);e[i].classList.add(l.ERROR),r&&(s&&n.scrollIntoView(r),this.addErrorMessage(r))}}addErrorMessage(e){if(e&&!e.classList.contains(l.ERROR)){e.classList.add(l.ERROR);const s=document.createElement("div");s.innerHTML=e.dataset.msg,s.classList.add("invalid-feedback"),e.parentNode.insertBefore(s,e.nextSibling)}}delErrorMessage(e){e&&e.classList.contains(l.ERROR)&&(e.classList.remove(l.ERROR),e.nextSibling.remove())}delGroupError(e){for(let s=0;s<e.length;s++){const i=this.getGroupParent(e[s]);e[s].classList.remove(l.ERROR),i&&this.delErrorMessage(i)}}isValidGroup(e){const s=e.length;let i=!1;for(let r=0;r<s;r++){const a=e[r];if(a.type==="checkbox"&&a.checked)i=!0;else if(a.type==="radio"&&a.checked)i=!0;else{const o=a.closest('input[type="text"]');o&&!i&&o.value.length>=this.minLengthOther&&(i=!0)}}return i}getGroupByName(e){return this.groups[e]}addValidation(){this.form&&[].forEach.call(this.form.querySelectorAll("[data-form-group]"),e=>{e.dataset.formGroup&&(this.addGroupValidation(e),this.addLiveValidation(e))})}isRadio(e){return(e==null?void 0:e.getAttribute("type"))==="radio"}isCheckbox(e){return(e==null?void 0:e.getAttribute("type"))==="checkbox"}addLiveValidation(e){e&&(this.isCheckbox(e)||this.isRadio(e)?e.addEventListener("change",this.handleLiveValidation.bind(this)):e.addEventListener("keyup",this.handleLiveValidation.bind(this)))}groupFilter(e,s){return e?e.filter(i=>i.getAttribute("type")===s):null}handleGroupError(e,s){e.checked?this.delGroupError(s):this.isValidGroup(s)||this.addGroupError(s)}handleLiveValidation(e){const s=e.currentTarget;if(s){const i=this.getGroupByName(s.dataset.formGroup);if(!i)return;const r=this.groupFilter(i,"checkbox"),a=this.groupFilter(i,"radio");s.getAttribute("type")==="checkbox"?this.handleGroupError(s,r):s.getAttribute("type")==="radio"?this.handleGroupError(s,a):this.isValidGroup(i)?this.delGroupError(i):this.addGroupError(i)}}getGroupParent(e){var s;return(s=e.closest(".js-form-message"))==null?void 0:s.querySelector("[data-msg]")}addGroupValidation(e){if(this.getGroupParent(e)){const i=e.dataset.formGroup;this.groups[i]||(this.groups[i]=[]),this.groups[i].push(e)}}updateGotcha(){const e=this.root.querySelector(this.gotchaSelector);e==null||e.classList.add(l.HIDDEN)}canHaveCustomSubmit(){return!this.root.classList.contains(b.noCustomSubmitClass)}static isOptionalInputInvisible(e){var s;return((s=e==null?void 0:e.parentNode)==null?void 0:s.classList.contains("form-field--show-in"))&&e.offsetParent===null}static getFormData(e){if(e==null)return[];const s=e.querySelectorAll('input[type="text"], input[type="email"], textarea'),i=[];for(let r=0;r<s.length;r++){const a=s[r];if(this.isOptionalInputInvisible(a))continue;let o;(a.type==="text"||a.type==="email"||a.tagName==="TEXTAREA")&&(o=a.value),i.push({input:a,value:o})}return i}},p(b,"rootSelector",".form"),p(b,"instances",[]),p(b,"delimiter","-formHelper-"),p(b,"noCustomSubmitClass","form--no-custom-submit"),p(b,"regularExpression",/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z]{2,6})+$/),b);class Ee{constructor(e){var i;this.position=e;const s=(i=window.i18n)==null?void 0:i.loader;s&&s.then(()=>{var r;this.translationData=(r=window.i18n)==null?void 0:r.getTranslationData(["positionTypePermanently","positionTypeInternship","positionTypeTraining","positionTypeStudent"])})}get description(){return this.position.jobDescriptions&&this.position.jobDescriptions.jobDescription&&this.position.jobDescriptions.jobDescription.map?this.position.jobDescriptions.jobDescription.map((e,s)=>this.getEnhanchedDescription(s,e.name,e.value["#cdata-section"])).join(`
`):null}hasStartingHtmlTag(e){return/^\s*<[^>]+>/.test(e)}getEnhanchedDescription(e,s,i){const r=e>0&&s&&s["#text"]?`<h4>${this.trimNewlines(s["#text"])}</h4>`:"";let a=i.replace(/<\/?span[^>]*>/g,""),o=0;const c=5,d=2;return e===0?a=a.replace(new RegExp("(?<=<\\/[^>]+>|^|<br>)([^<]+)(?=<[^>]+>|$|<br>)","g"),(h,u)=>u.length>c&&/^\s*$/.test(u)?u:o<d&&u.length>c&&u[0]!==","?(o++,"<p>"+u.trim()+"</p>"):u).replace(/<\/p><br>/g,"<br></p>"):!this.hasStartingHtmlTag(a)&&a.length>c&&(a="<p>"+a+"</p>"),`${r}${a}`.replace(/<\/p><br><p>/g,"</p><p>")}get id(){return this.getValue("id").replace(/\s/g,"")}get title(){return this.removeGenderNotations(this.getValue("name"))}removeGenderNotations(e){const s=/\(m\/w\/d\)|\(m\/f\/d\)|\(h\/m\/d\)/gi;return e.replace(s,"").trim()}get tags(){const e=this.getValue("keywords");return e?e.split(","):[]}getTeamText(e){if(!e)return;let s=e;if(s.includes("/")){const i=s.split(" / "),r=i[0],a=i[1],o="CSOC",c="Managed Services",d="Products";if(r===c&&a!==o)s=c;else if(r===d)s=`${d} ${a}`;else switch(a){case"Azure Architecture":s="Azure";break;case"M365 Architecture":s="Workplace";break;case o:s="Security";break;default:s=a;break}}return s+" Team"}get team(){const e=this.getTeamText(this.getValue("department")),s=e?" / ":"";return`${e||""}${this.positionType?s+this.positionType:""}`}get data(){return{id:this.id,title:this.title,description:this.description,team:this.team,position_type:this.positionType,tags:this.tags,order:this.order}}get positionType(){var s,i,r,a;let e=this.getValue("employmentType");switch(e){case"permanent":e=(s=window.i18n)==null?void 0:s.translate("positionTypePermanently");break;case"intern":e=(i=window.i18n)==null?void 0:i.translate("positionTypeInternship");break;case"trainee":e=(r=window.i18n)==null?void 0:r.translate("positionTypeTraining");break;case"working_student":e=(a=window.i18n)==null?void 0:a.translate("positionTypeStudent");break;default:case"freelance":case"temporary":e=null;break}return e}get order(){const e=this.tags.find(r=>r.includes("ORDER_"));if(!e)return null;const s=e.split("_")[1];return parseInt(s,10)}trimNewlines(e){return e.replace(/\n|\t|    /g,"")}getValue(e,s="text"){return this.position&&this.position[e]?this.trimNewlines(this.position[e][`#${s}`]):null}}const z={VALID:200,CREATED:201,NO_CONTENT:204,BAD_REQUEST:400,UNAUTHORIZED:401,FORBIDDEN:403,NOT_FOUND:404,PAYLOAD_TOO_LARGE:413,INTERNAL_SERVER_ERROR:500};class Pe{constructor(e){p(this,"defaultLang","de");p(this,"types",{OPENINGS:"openings",APPLICATIONS:"applications",DOCUMENTS:"documents"});p(this,"recruitingChannels",{CAREER_PAGE:1610421});p(this,"phaseIds",{NEW_APPLICATION:890494});p(this,"responseTypes",{XML:"xml",JSON:"json"});p(this,"defaultClientName","c4a8");p(this,"mockApplyUrl","mock/jobApply.json");p(this,"mockDocumentsUrl","mock/jobDocuments.json");this.options=e,(!this.options.client_name||this.options.client_name==="glueckkanja")&&(this.options.client_name=this.defaultClientName),this.lang=this.defaultLang,this.jobId=null,this.apiUrl="https://api.personio.de/v1",this.openingsUrl=`https://${this.options.client_name}.jobs.personio.de/xml`,this.applicationsUrl="https://apim-c4a8-recruiting-prd-weu.azure-api.net/applications",this.documentsUrl="https://apim-c4a8-recruiting-prd-weu.azure-api.net/applications/documents"}getUrl(e){var r;let s;e!==this.types.OPENINGS&&((r=this.options.apiUrl)!=null&&r.match(/.xml$/))?e===this.types.APPLICATIONS?s=this.options.mockApplyUrl?this.options.mockApplyUrl:this.mockApplyUrl:s=this.options.mockDocumentsUrl?this.options.mockDocumentsUrl:this.mockDocumentsUrl:s=this.options.apiUrl?this.options.apiUrl:this[`${e}Url`];const i=this.lang!==this.defaultLang?this.options.apiUrl?"":`?language=${this.lang}`:"";return`${s}${i}`}setLang(e){this.lang=e}setFilter(e){this.filter=e}getAll(){const e=this.getUrl(this.types.OPENINGS);return this.fetch(e,null,this.responseTypes.XML)}getOpening(e){return this.options.jobId=e,this.getAll()}convertPosition(e){var a;const s=new Ee(e),i=(a=this.options)==null?void 0:a.jobId;return s.description===null||i&&s.id!==i||!this.filterPosition(s)?null:{...s.data,lang:this.lang}}filterPosition(e){var s,i;return!((i=(s=this.filter)==null?void 0:s.tags)!=null&&i.length)||this.filter.tags.some(r=>e.tags.map(a=>a.toLowerCase()).includes(r.toLowerCase()))?e:null}convertData(e){var a,o;const s=e,i="workzag-jobs",r=(a=e[i])==null?void 0:a.position;return s.objects=r.length?(o=e[i])==null?void 0:o.position.map(c=>this.convertPosition(c)).filter(Boolean):[this.convertPosition(r)].filter(Boolean),s.meta={offset:0,limit:20,total:10},s}getConvertedJson(e){const i=new DOMParser().parseFromString(e,"application/xml"),r=n.XMLtoJSON(i);return this.convertData(r)}fetchXML(e){return new Promise((s,i)=>{e.then(r=>r.text()).then(r=>{s({json:()=>this.getConvertedJson(r)})}).catch(r=>{console.error("Personio fetchXML Error:",r),i("Personio fetchXML Error")})})}fetch(e,s,i){return new Promise((r,a)=>{var o;if((o=this.options)!=null&&o.client_name){const c=fetch(e,s),d=i===this.responseTypes.XML?this.fetchXML(c):c;r(d)}else a("no client_name specified")})}async uploadDocuments(e){const s=e.length>0?e:[e],i=[];return Array.from(s).forEach(r=>{i.push(this.uploadDocument(r))}),Promise.all(i)}async uploadDocument(e){const s=this.getUrl(this.types.DOCUMENTS),i=new FormData;return i.append("file",new File([e],e.name,{type:e.type})),this.fetch(s,{method:"POST",body:i,headers:{...this.getHeaders()}})}async applyFileData(e,s,i){return new Promise((r,a)=>{this.uploadDocuments(e).then(o=>{if(this.hasValidResponseCodes(o))return this.addFilesToFields(o,i,r,a);const c=o[0];c.json().then(d=>{if(d.errors)return a({statusCode:c.status,errors:d.errors})}).catch(d=>a(d))}).catch(o=>a(o))})}addFilesToFields(e,s,i,r){const a=s;a.files=[];const o=e.map(c=>c.json().then(d=>{a.files.push({uuid:d.uuid,original_filename:d.original_filename,category:"cv"})}));return Promise.all(o).then(()=>i(a)).catch(c=>r(c))}getMappedFieldName(e){let s;switch(e){case"salary":s="salary_expectations";break;case"cancellation":s="available_from";break;case"gender":case"birthday":case"location":case"phone":s=e;break;default:s="custom_attribute_"+e;break}return s}isValidResponseCode(e){return this.options.apiUrl?e.status===z.VALID:e.status===z.VALID||e.status===z.CREATED||e.status===z.NO_CONTENT}hasValidResponseCodes(e){return e.every(s=>this.isValidResponseCode(s))}handleApply(e){return new Promise((s,i)=>{this.apply({fields:e}).then(r=>{if(this.isValidResponseCode(r))return s();r.json().then(a=>{if(a.errors)return i({statusCode:r.status,errors:a.errors})}).catch(a=>i(a))}).catch(r=>i(r))})}getFormPayload(e,s){const i={job_position_id:parseInt(this.options.jobId),attributes:[],phase:{type:"custom",id:this.phaseIds.NEW_APPLICATION},recruiting_channel_id:this.recruitingChannels.CAREER_PAGE},r={first_name:!0,last_name:!0,email:!0,message:!0};for(let a=0;a<e.length;a++){const c=e[a].input,d=s.getName(c.name),h=n.camalCaseToSnakeCase(d);r.hasOwnProperty(h)?i[h]=c.value:h!=="_gotcha"&&i.attributes.push({id:this.getMappedFieldName(h),value:c.value})}return i}getHeaders(){return{"Ocp-Apim-Subscription-Key":this.options.apiKey}}async apply(e){const s=this.getUrl(this.types.APPLICATIONS);return this.fetch(s,{method:"POST",body:JSON.stringify(e.fields),headers:{...this.getHeaders(),"Content-Type":"application/json"}})}}class te{constructor(e){p(this,"jobDataUrl","/assets/data/jobs/");this.options=e,this.api=new Pe(this.options),this.jobDataUrl=n.getSiteAssetPath(this.jobDataUrl)}setLang(e){this.api.setLang(e)}setFilter(e){this.api.setFilter(e)}getAll(){return this.api.getAll()}getOpening(e){return this.api.getOpening(e)}getUrl(e,s,i){return this.api.getUrl(e,s,i)}fetch(e,s){return this.api.fetch(e,s)}getLangFromEntry(e){return e.lang||null}getJobId(){let e="";const s=window.location.hash;if(s)if(s.indexOf("-")!==-1){const i=s.split("-");e=i[i.length-1]}else e=s.substring(1);else this.options.jobId&&(e=this.options.jobId);return e}getOrderedList(e){const s=e.filter(r=>r.order!==void 0).sort((r,a)=>a.order-r.order),i=e.filter(r=>r.order===void 0);return[...s,...i]}getFormData(e){const s=ee.getFormData(e);return this.api.getFormPayload(s,ee)}applyFileData(e,s,i){return this.api.applyFileData(e,s,i)}handleApply(e){return this.api.handleApply(e)}}const I=class I{constructor(e,s){this.root=e,this.options=s,this.closeSelector=".modal__close",this.successCloseSelector=".modal__success-close .cta",this.errorCloseSelector=".modal__error-close .cta",this.applicationSelector=".modal__application",this.modalSuccessHeadlineSelector=".modal__success-headline > *",this.buttonSelector='[data-trigger="modal"]',this.formSelector=".form",this.close=this.root.querySelector(this.closeSelector),this.successClose=this.root.querySelector(this.successCloseSelector),this.errorClose=this.root.querySelector(this.errorCloseSelector),this.application=this.root.querySelector(this.applicationSelector),this.form=this.root.querySelector(this.formSelector),this.modalId=this.root.dataset.modalId,this.root.classList.add(l.READY),this.application&&(this.clientName=this.root.dataset.clientName,this.apiUrl=this.root.dataset.apiUrl,this.jobId=this.root.dataset.jobId,this.apiKey=this.root.dataset.apiKey,this.mockApplyUrl=this.root.dataset.mockApplyUrl,this.mockDocumentsUrl=this.root.dataset.mockDocumentsUrl,this.api=new te({...this.jobId&&{jobId:this.jobId},...this.apiUrl&&{apiUrl:this.apiUrl},client_name:this.clientName,apiKey:this.apiKey,mockApplyUrl:this.mockApplyUrl,mockDocumentsUrl:this.mockDocumentsUrl})),this.bindEvents()}isNotVueApp(e){return e.getAttribute("data-v-app")===null}bindEvents(){var e,s,i;if((e=this.close)==null||e.addEventListener("click",this.handleClose.bind(this)),(s=this.successClose)==null||s.addEventListener("click",this.handleClose.bind(this)),(i=this.errorClose)==null||i.addEventListener("click",this.handleClose.bind(this)),this.application){const r=this.root.parentNode,a=ee.getInstance(this.form);if(r&&this.isNotVueApp(r)){const o=r.querySelector(this.buttonSelector);o==null||o.addEventListener("click",this.handleOpen.bind(this))}else r&&this.addTriggerListeners();a&&a.canHaveCustomSubmit()&&(a.customSubmit=this.handleApplicationSubmit.bind(this))}else this.root.dataset.modalId&&this.addTriggerListeners();document.addEventListener(f.OPEN_MODAL,this.handleModalOpen.bind(this))}addTriggerListeners(){document.querySelectorAll(`[data-trigger-id='${this.modalId}']`).forEach(s=>s.addEventListener("click",this.handleOpen.bind(this)))}handleModalOpen(e){var i;e.stopImmediatePropagation();const s=(i=e==null?void 0:e.detail)==null?void 0:i.id;!s||s!==this.modalId||this.handleOpen(e)}handleApplicationSubmit(e){e.preventDefault(),e.stopImmediatePropagation(),this.setLoading(!0);const s=this.form.querySelector(F.base64Selector),i=s==null?void 0:s.value;let r=this.api.getFormData(this.form),a;if(i)a={name:s.dataset.fileName};else{const o=this.form.querySelector('input[type="file"]');a=o==null?void 0:o.files}a?this.handleApplicationRequest(r,a,i):this.handleError()}setLoading(e){document.dispatchEvent(new CustomEvent(f.LOAD_MODAL,{detail:e}))}handleApplicationRequest(e,s,i){this.api.applyFileData(s,i,e).then(r=>{this.api.handleApply(r).then(()=>{this.setLoading(!1),this.handleApplicationSuccess(r)}).catch(a=>{this.setLoading(!1),this.handleError(a)})}).catch(r=>{this.setLoading(!1),this.handleError(r)})}handleApplicationSuccess(e){this.root.classList.add(l.SUCCESS);const s=this.root.querySelector(this.modalSuccessHeadlineSelector);if(s){s.dataset.text||(s.dataset.text=s.innerText);const i=e.first_name;s.innerText=`${s.dataset.text} ${i}`}}handleError(e){if(!e)return console.error("handle generic error");const s=typeof e=="string"?e:e.message?e.message:e,i=typeof e=="object"&&e.statusCode?e.statusCode:z.INTERNAL_SERVER_ERROR;console.error("Modal Error",s),i===z.PAYLOAD_TOO_LARGE?this.handlePayloadTooLarge(e):this.root.classList.add(l.ERROR)}handlePayloadTooLarge(e){document.dispatchEvent(new CustomEvent(f.FORM_ATTACHMENT_ERROR,{detail:e}))}handleClose(e){e.preventDefault(),I.close(this.root)}handleOpen(e){e.preventDefault(),I.open(this.root)}static initElement(e,s){const i=new this(e,s);return this.instances.push(i),i}static open(e){e&&window.$&&$(e).modal("show")}static close(e){e&&window.$&&($(e).modal("hide"),I.resetModal(e))}static resetModal(e){setTimeout(function(){const s=e.querySelector("form");s==null||s.reset(),e.classList.remove(l.SUCCESS),e.classList.remove(l.ERROR)},200)}static init(e){this.instances=[];const s=e||document,i=`${this.rootSelector}:not(.${l.READY})`;[].forEach.call(s.querySelectorAll(i),r=>{this.initElement(r)})}};p(I,"rootSelector",".modal"),p(I,"instances",[]);let R=I;const se="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 100 100' height='400' width='400'%3E%3Cpath fill='%23e5f8ff' stroke='%23DAEDF7' stroke-miterlimit='10' d='M50.28 90C72.3714 90 90.28 72.0914 90.28 50C90.28 27.9086 72.3714 10 50.28 10C28.1886 10 10.28 27.9086 10.28 50C10.28 72.0914 28.1886 90 50.28 90Z'%3E%3C/path%3E%3Cpath fill='%23f5f5f5' stroke='%23000000' stroke-linecap='round' stroke-linejoin='round' d='M66.226 41.1997H16.464C15.9336 41.1997 15.4248 41.4104 15.0498 41.7855C14.6747 42.1606 14.464 42.6693 14.464 43.1997V75.3337H68.226V43.1997C68.226 42.6693 68.0153 42.1606 67.6402 41.7855C67.2651 41.4104 66.7564 41.1997 66.226 41.1997Z'%3E%3C/path%3E%3Cpath fill='%23ff6242' d='M64.431 44.9966H18.312L18.259 75.3336H64.431V44.9966Z'%3E%3C/path%3E%3Cpath fill='%23ff866e' d='M52.994 44.9966L20.42 75.3336H18.259L18.312 44.9966H52.994Z'%3E%3C/path%3E%3Cpath stroke='%23000000' stroke-linecap='round' stroke-linejoin='round' d='M64.431 44.9966H18.312L18.259 75.3336H64.431V44.9966Z'%3E%3C/path%3E%3Cpath fill='%23000000' d='M41.345 84.2985C55.3178 84.2985 66.645 83.5598 66.645 82.6485C66.645 81.7373 55.3178 80.9985 41.345 80.9985C27.3722 80.9985 16.045 81.7373 16.045 82.6485C16.045 83.5598 27.3722 84.2985 41.345 84.2985Z' opacity='.15'%3E%3C/path%3E%3Cpath fill='%23f5f5f5' stroke='%23000000' stroke-linecap='round' stroke-linejoin='round' d='M72.97 79.1286H9.72V76.3286C9.72 76.0634 9.82536 75.809 10.0129 75.6215C10.2004 75.434 10.4548 75.3286 10.72 75.3286H71.97C72.2352 75.3286 72.4896 75.434 72.6771 75.6215C72.8646 75.809 72.97 76.0634 72.97 76.3286V79.1286Z'%3E%3C/path%3E%3Cpath fill='%23adc4d9' stroke='%23000000' stroke-linecap='round' stroke-linejoin='round' d='M72.97 79.1289C67.0954 80.8072 61.0156 81.6587 54.906 81.6589H27.784C21.6744 81.6586 15.5946 80.8071 9.72 79.1289H72.97Z'%3E%3C/path%3E%3Cpath fill='%23ffffff' stroke='%23e04122' stroke-linecap='round' stroke-linejoin='round' d='M46.145 67.3147C45.8364 67.3155 45.5307 67.2551 45.2456 67.137C44.9605 67.0189 44.7017 66.8454 44.484 66.6267L41.345 63.4887L38.207 66.6267C37.9885 66.8449 37.7292 67.0179 37.4439 67.1359C37.1586 67.2539 36.8528 67.3145 36.5441 67.3143C36.2353 67.3141 35.9296 67.2531 35.6444 67.1348C35.3593 67.0165 35.1002 66.8431 34.882 66.6247C34.6638 66.4062 34.4908 66.1469 34.3728 65.8616C34.2548 65.5763 34.1942 65.2705 34.1944 64.9618C34.1945 64.653 34.2555 64.3473 34.3739 64.0621C34.4922 63.777 34.6655 63.5179 34.884 63.2997L38.022 60.1607L34.884 57.0227C34.6602 56.8058 34.4818 56.5465 34.3592 56.2599C34.2365 55.9734 34.1721 55.6653 34.1697 55.3536C34.1673 55.042 34.2269 54.7329 34.345 54.4445C34.4632 54.1561 34.6376 53.894 34.8579 53.6737C35.0783 53.4533 35.3404 53.2789 35.6288 53.1608C35.9172 53.0426 36.2262 52.983 36.5379 52.9854C36.8496 52.9878 37.1577 53.0522 37.4442 53.1749C37.7308 53.2975 37.99 53.4759 38.207 53.6997L41.345 56.8387L44.484 53.6997C44.927 53.2703 45.521 53.0323 46.1379 53.0371C46.7548 53.0419 47.3451 53.2891 47.7813 53.7253C48.2176 54.1616 48.4648 54.7519 48.4696 55.3688C48.4744 55.9857 48.2364 56.5797 47.807 57.0227L44.668 60.1607L47.807 63.2997C48.1354 63.6284 48.359 64.0471 48.4496 64.5029C48.5401 64.9586 48.4935 65.431 48.3156 65.8603C48.1377 66.2895 47.8366 66.6565 47.4502 66.9146C47.0639 67.1728 46.6097 67.3106 46.145 67.3107V67.3147Z'%3E%3C/path%3E%3Cpath fill='%2300b8f0' d='M84.69 15.6548H48.261C46.4158 15.6548 44.92 17.1506 44.92 18.9958V46.6608C44.92 48.506 46.4158 50.0018 48.261 50.0018H84.69C86.5352 50.0018 88.031 48.506 88.031 46.6608V18.9958C88.031 17.1506 86.5352 15.6548 84.69 15.6548Z'%3E%3C/path%3E%3Cpath fill='%2380ddff' d='M71.567 15.6548H48.261C47.8219 15.6548 47.3871 15.7413 46.9815 15.9095C46.5759 16.0776 46.2074 16.3241 45.8971 16.6348C45.5868 16.9454 45.3408 17.3142 45.1732 17.72C45.0055 18.1258 44.9195 18.5607 44.92 18.9998V42.2998L71.567 15.6548Z'%3E%3C/path%3E%3Cpath stroke='%23000000' stroke-linecap='round' stroke-linejoin='round' d='M84.69 15.6548H48.261C46.4158 15.6548 44.92 17.1506 44.92 18.9958V46.6608C44.92 48.506 46.4158 50.0018 48.261 50.0018H84.69C86.5352 50.0018 88.031 48.506 88.031 46.6608V18.9958C88.031 17.1506 86.5352 15.6548 84.69 15.6548Z'%3E%3C/path%3E%3Cpath fill='%23ffffff' d='M84.69 15.6548H48.261C47.8219 15.6548 47.3871 15.7413 46.9815 15.9095C46.5759 16.0776 46.2074 16.3241 45.8971 16.6348C45.5868 16.9454 45.3408 17.3142 45.1732 17.72C45.0055 18.1258 44.9195 18.5607 44.92 18.9998V23.5998H88.031V18.9998C88.0315 18.5607 87.9455 18.1258 87.7778 17.72C87.6102 17.3142 87.3641 16.9454 87.0538 16.6348C86.7436 16.3241 86.3751 16.0776 85.9695 15.9095C85.5638 15.7413 85.1291 15.6548 84.69 15.6548V15.6548Z'%3E%3C/path%3E%3Cpath stroke='%23000000' stroke-linecap='round' stroke-linejoin='round' d='M84.69 15.6548H48.261C47.8219 15.6548 47.3871 15.7413 46.9815 15.9095C46.5759 16.0776 46.2074 16.3241 45.8971 16.6348C45.5868 16.9454 45.3408 17.3142 45.1732 17.72C45.0055 18.1258 44.9195 18.5607 44.92 18.9998V23.5998H88.031V18.9998C88.0315 18.5607 87.9455 18.1258 87.7778 17.72C87.6102 17.3142 87.3641 16.9454 87.0538 16.6348C86.7436 16.3241 86.3751 16.0776 85.9695 15.9095C85.5638 15.7413 85.1291 15.6548 84.69 15.6548V15.6548Z'%3E%3C/path%3E%3Cpath fill='%23ff6242' d='M49.932 21.279C50.8549 21.279 51.603 20.5309 51.603 19.608C51.603 18.6851 50.8549 17.937 49.932 17.937C49.0091 17.937 48.261 18.6851 48.261 19.608C48.261 20.5309 49.0091 21.279 49.932 21.279Z'%3E%3C/path%3E%3Cpath fill='%23ffe500' d='M55.789 21.279C56.7119 21.279 57.46 20.5309 57.46 19.608C57.46 18.6851 56.7119 17.937 55.789 17.937C54.8661 17.937 54.118 18.6851 54.118 19.608C54.118 20.5309 54.8661 21.279 55.789 21.279Z'%3E%3C/path%3E%3Cpath fill='%2348cf3e' d='M61.646 21.279C62.5688 21.279 63.317 20.5309 63.317 19.608C63.317 18.6851 62.5688 17.937 61.646 17.937C60.7231 17.937 59.975 18.6851 59.975 19.608C59.975 20.5309 60.7231 21.279 61.646 21.279Z'%3E%3C/path%3E%3Cpath fill='%23000000' d='M55.999 34.052C56.9103 34.052 57.649 33.3132 57.649 32.402C57.649 31.4907 56.9103 30.752 55.999 30.752C55.0877 30.752 54.349 31.4907 54.349 32.402C54.349 33.3132 55.0877 34.052 55.999 34.052Z'%3E%3C/path%3E%3Cpath fill='%23000000' d='M76.899 34.052C77.8103 34.052 78.549 33.3132 78.549 32.402C78.549 31.4907 77.8103 30.752 76.899 30.752C75.9877 30.752 75.249 31.4907 75.249 32.402C75.249 33.3132 75.9877 34.052 76.899 34.052Z'%3E%3C/path%3E%3Cpath fill='%23c7f0ff' stroke='%233887B7' stroke-linecap='round' stroke-linejoin='round' d='M80.12 39.6307C80.1097 40.0406 79.9395 40.4302 79.646 40.7165C79.3524 41.0028 78.9585 41.163 78.5485 41.163C78.1384 41.163 77.7446 41.0028 77.451 40.7165C77.1574 40.4302 76.9873 40.0406 76.977 39.6307C76.977 38.7627 78.549 35.7017 78.549 35.7017C78.549 35.7017 80.12 38.7627 80.12 39.6307Z'%3E%3C/path%3E%3Cpath fill='%23ffb59e' stroke='%23000000' stroke-linecap='round' stroke-linejoin='round' d='M61.727 44.2536C61.5404 44.2535 61.3563 44.2108 61.1886 44.1288C61.021 44.0468 60.8743 43.9277 60.7596 43.7804C60.645 43.6332 60.5654 43.4618 60.527 43.2791C60.4886 43.0965 60.4924 42.9076 60.538 42.7266C60.8732 41.4135 61.6361 40.2494 62.7064 39.418C63.7766 38.5866 65.0933 38.1353 66.4485 38.1353C67.8037 38.1353 69.1204 38.5866 70.1906 39.418C71.2609 40.2494 72.0238 41.4135 72.359 42.7266C72.406 42.9073 72.4106 43.0964 72.3722 43.2791C72.3339 43.4618 72.2537 43.6331 72.138 43.7796C72.0236 43.9274 71.8769 44.0469 71.7091 44.1291C71.5413 44.2113 71.3569 44.2539 71.17 44.2536C69.6156 43.9216 68.0367 43.7176 66.449 43.6436C64.861 43.7176 63.2817 43.9216 61.727 44.2536V44.2536Z'%3E%3C/path%3E%3C/svg%3E",ie={de:{tags:"Schlagwörter",tagsHeadline:"Posts nach Schlagwörtern",tagsClear:"Zurücksetzen",posts:"Einträge",follow:"Folgen",similarPosts:"Ähnliche Artikel",withAuthor:"Mit",adBlockInfo:`
        <div class="ad-block-info__content">
          <img src="${se}" alt="Full Service" class="is-svg">
        ...
        </div>`,vatInfo:"*Todos los precios son sin IVA. Nuestras ofertas se dirigen exclusivamente a clientes profesionales."}}[n.getLang()],Ne=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"ad-block-info",props:{text:String,show:{default:null}},computed:{textValue(){return this.text.length>0?this.text:ie==null?void 0:ie.adBlockInfo}},data(){return{disableDelay:30*24*60*60*1e3,storageKey:"adBlockInfo"}},mounted(){this.bindEvents(),n.isTrue(this.show)&&this.openModal()},methods:{bindEvents(){this.isDisabled()||document.addEventListener(f.AD_BLOCK_INFO,()=>{this.openModal()})},openModal(){var t;R.open((t=this.$refs["modal-component"])==null?void 0:t.modal),this.disableInfoByTime()},disableInfoByTime(){const t=Date.now()+this.disableDelay;n.storageSave(this.storageKey,t)},isDisabled(){const t=n.storageGet(this.storageKey);return t&&t>0&&Date.now()<=t}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Ae=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"aside-wrapper",methods:{},props:{},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Ve=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"carousel",components:{"carousel-item":{tagName:"carousel-item",template:`
  ...
  `,props:{item:Object}}},data(){return{clientWidth:null,resizeObserver:null}},computed:{jsonItems(){return n.getJSON(this.items)},classList(){return["carousel vue-component",this.bgColor?l.HAS_BACKGROUND:""]},style(){return[this.bgColor?`--color-carousel-background: ${this.bgColor};`:"",this.clientWidth?`--animation-scroll-width: -${this.clientWidth}px;`:""]}},mounted(){const t=this.$refs["row-section"];this.resizeObserver=new ResizeObserver(e=>{for(let s of e)s.target===t&&(this.clientWidth=s.contentRect.width)}),t&&(this.resizeObserver.observe(t),window.addEventListener("resize",this.updateClientWidth))},beforeDestroy(){window.removeEventListener("resize",this.updateClientWidth)},methods:{updateClientWidth(){var t;this.clientWidth=(t=this.$refs["row-section"])==null?void 0:t.clientWidth}},props:{items:Array,bgColor:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Re=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"content-scroller",data(){return{blockScrollPercentage:[],scrollDistancePercentage:0,minHeight:0,blockCount:0,isScrolledUpOut:!1,isScrolledDownOut:!1}},computed:{blocksValue(){return n.getJSON(this.blocks)},headlineValue(){const t=n.getJSON(this.headline);return{...t,level:t.level||"h2",classes:`content-scroller__headline ${t.classes||"h3-font-size"}`}},overlappingSizeValue(){return this.overlappingSize||"mt-md-n10"},style(){return{"--content-scroller-min-height":`${this.minHeight}px`}}},props:{headline:{default:null},blocks:Array,overlappingSize:String},mounted(){this.calcBlockCount(),this.$nextTick(()=>{this.handleResize()}),window.addEventListener("scroll",this.handleScroll),window.addEventListener("resize",this.handleResize)},beforeDestroy(){window.removeEventListener("scroll",this.handleScroll),window.removeEventListener("resize",this.handleResize)},methods:{handleScroll(){this.calcScrollDistancePercentage(),this.updateBlocks()},handleResize(){this.calcMinHeight(),this.handleScroll()},resetIsScrolledUpOut(){const t=this.$refs.block;t&&(t.forEach((e,s)=>{this.setBlockMinPercentage(s)}),this.isScrolledUpOut=!0)},resetIsScrolledDownOut(){const t=this.$refs.block;t&&(t.forEach((e,s)=>{this.setBlockMaxPercentage(s)}),this.isScrolledDownOut=!0)},setBlockMaxPercentage(t){this.blockScrollPercentage[t]=100},setBlockMinPercentage(t){this.blockScrollPercentage[t]=0},updateBlocks(){if(!this.isScrolledUpOut&&this.scrollDistancePercentage<=0)return this.resetIsScrolledUpOut();if(!this.isScrolledDownOut&&this.scrollDistancePercentage>=100)return this.resetIsScrolledDownOut();if(this.scrollDistancePercentage<=0||this.scrollDistancePercentage>=100)return;this.isScrolledUpOut=!1,this.isScrolledDownOut=!1;const s=100/this.blockCount,i=this.$refs.block;i&&i.forEach((r,a)=>{const o=a*s,c=(a+1)*s;if(this.scrollDistancePercentage>=o&&this.scrollDistancePercentage<=c){let d=(this.scrollDistancePercentage-o)/s*100;this.blockScrollPercentage[a]=d}else this.scrollDistancePercentage<o?this.setBlockMinPercentage(a):this.scrollDistancePercentage>c&&this.setBlockMaxPercentage(a)})},getViewportHeight(){return window.innerHeight},calcScrollDistancePercentage(){const t=this.$el,e=window.scrollY,s=t.getBoundingClientRect().top+window.scrollY,r=t.offsetHeight/2;let a=0;e>=s&&(a=(e-s)/r*100),this.scrollDistancePercentage=a},calcBlockCount(){const t=this.blocks.length;t&&(this.blockCount=t)},calcBlockStyle(t){return[{"--content-scroller-block-scroll-percentage":this.blockScrollPercentage[t]}]},calcMinHeight(){const t=this.$refs.placeholder;t&&(this.minHeight=t.offsetHeight)}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),He=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"cta",computed:{tag(){return this.href||this.alternativeHref||this.target?"a":"button"},hasIcon(){return this.link||this.externalValue||this.icon||this.downloadValue},externalValue(){return n.isTrue(this.external)},downloadValue(){return n.isTrue(this.download)},classList(){return[`${this.baseClass} ${this.innerSkin}`,this.classes?this.classes:"",this.download?"cta--download":"",this.external?"cta--external":"",this.icon?`cta--has-icon cta--icon-${this.icon}`:"",n.isTrue(this.reversed)===!0?"cta--reversed":"",n.isTrue(this.monochrome)===!0?"cta--monochrome":"",this.link&&n.isTrue(this.active)===!0?l.ACTIVE:"",n.isTrue(this.loading)?l.LOADING:"",n.isTrue(this.hasBackground)===!0?"cta--has-background":"","vue-component"]},innerSkin(){return this.link?this.skin?this.skin:"":this.skin?`btn-${this.skin}`:"btn-primary"},innerWidth(){return this.width?this.width:`w-100 ${this.grow?"":"w-lg-auto"}`},baseClass(){let t=this.$.type.tagName;return this.link?t+=" link":t+=" btn "+this.innerWidth,t},iconName(){let t;return this.icon?t=this.icon:this.externalValue||this.downloadValue?t="arrow-external":this.link&&(t="arrow"),t},targetValue(){return this.externalValue?"_blank":this.target},sizeValue(){return"medium"}},props:{href:{default:null},button:Boolean,text:String,analytics:{default:null},link:Boolean,external:{default:null},skin:String,width:String,grow:Boolean,type:String,target:String,alternativeHref:{default:null},trigger:String,icon:String,download:{default:null},reversed:{default:null},monochrome:{default:null},active:{default:null},classes:{default:"",type:String},loading:{default:null},hasBackground:{default:null}},template:`
    ...
    </component>`}},Symbol.toStringTag,{value:"Module"})),v=class v{constructor(e){this.root=e,this.count=1,this.selector=this.getCurrentSelector(),this.currentElements=this.root.querySelectorAll(this.selector),this.root.matches(this.selector)&&(this.currentElements=this.mergeNodes(this.root,this.currentElements)),this.resetAnimation(),this.initialize()}resetAnimation(){this.root.querySelectorAll(`.${l.IS_STARTING}`).forEach(e=>{e.classList.remove(l.IS_STARTING)})}mergeNodes(e,s){const i=Array.from(s);return i.unshift(e),i}getCurrentSelector(){return`[data-utility-animation-step="${this.count}"]`}updateCurrentElement(e){const s=[];this.currentElements.forEach(i=>{e.srcElement!==i&&s.push(i)}),this.currentElements=s}handleAnimationEnd(e){const s=v.getGroup(e.srcElement);if(s){const i=parseInt(s.style.getPropertyValue(v.groupItemsLoadedProperty),10)||0;v.setGroupItemsLoaded(s,i+1)}this.updateCurrentElement(e),!(this.currentElements.length>0)&&(this.count++,this.currentElements=this.root.querySelectorAll(this.getCurrentSelector()),this.currentElements!==null&&this.currentElements.length>0?this.startStepAnimation(this.currentElements):this.setEnd())}startStepAnimation(e){e.forEach(s=>{s.classList.add(l.IS_STARTING)})}setEnd(){this.root.setAttribute(v.endDataset,!0)}startAnimation(){this.startStepAnimation(this.currentElements)}static getGroup(e){return e.closest(".utility-animation__group")}initialize(){this.root.addEventListener("animationend",s=>{this.handleAnimationEnd(s)}),new MutationObserver(s=>{s.forEach(i=>{var r;i.type==="attributes"&&i.attributeName.startsWith(v.inViewportDataset)&&((r=i.target)==null?void 0:r.getAttribute(v.inViewportDataset))==="true"&&this.startAnimation()})}).observe(this.root,{attributes:!0})}static setGroupItemsLoaded(e,s){e.style.setProperty(this.groupItemsLoadedProperty,s)}static hasPercentageOffset(e){return e.root.classList.contains("utility-animation--percentage-offset")}static hasSmallOffset(e){return e.root.classList.contains("utility-animation--small-offset")}static addObserver(e){const r=h=>{h.forEach(u=>{u.isIntersecting?u.target.setAttribute(this.inViewportDataset,!0):u.target.classList.contains("utility-animation--enter-exit")&&u.target.removeAttribute(this.inViewportDataset)})},a=new IntersectionObserver(r,{rootMargin:"0px 0px -200px 0px",threshold:0}),o=new IntersectionObserver(r,{rootMargin:"0px 0px 0px 0px",threshold:.4}),c=new IntersectionObserver(r,{rootMargin:"0px 0px -100px 0px",threshold:0});(e?[e]:this.instances).forEach(h=>{v.hasSmallOffset(h)?c.observe(h.root):v.hasPercentageOffset(h)?o.observe(h.root):a.observe(h.root)})}static resetGroup(e){this.setGroupItemsLoaded(e,0),this.instances.forEach(s=>{if(this.getGroup(s.root)===e){const r=s.root;s.currentElements=[r],r.removeAttribute("data-utility-animation-end"),s.startAnimation()}})}static initElement(e){const s=e.$el?e.$el:e,i=new this(s);return this.instances.push(i),i}static init(e){this.instances=[],[].forEach.call(e||document.querySelectorAll(this.rootSelector),s=>{this.initElement(s)}),this.addObserver()}static isElementObserved(e){return this.instances.some(s=>s.root===e)}static observeElementIfNotAlready(e){let s;this.isElementObserved(e)||(s=this.initElement(e)),this.addObserver(s)}static getIndexStyle(e){return`--utility-animation-index: ${e}`}};p(v,"rootSelector",".utility-animation"),p(v,"inViewportDataset","data-utility-animation-in-viewport"),p(v,"endDataset","data-utility-animation-end"),p(v,"instances",[]),p(v,"groupItemsLoadedProperty","--utility-animation-items-loaded");let j=v;const Ge=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"dropdown",props:{label:String,items:String,filterable:{default:null},hasAnimation:{default:null},index:Number},computed:{teleportSelector(){return'[id="root"], [data-v-app]'},dropdownLabelClasses(){return["dropdown__label font-size-sm",this.hasAnimation?"utility-animation fade-in-bottom":""]},parsedItems(){return n.getJSON(this.items)},filteredItems(){return this.filterableValue&&this.filterText.length>=this.minCharsToFilter?this.parsedItems.filter(t=>t.text.toLowerCase().includes(this.filterText.toLowerCase())):this.parsedItems},filterableValue(){return n.isTrue(this.filterable)===!0},style(){return this.hasAnimation?`--utility-animation-index: ${this.index};`:""}},methods:{initActiveSelection(){this.activeSelection=this.filteredItems.filter(t=>t.checked)},updateUtilityAnimation(){this.hasAnimation&&j.observeElementIfNotAlready(this.$refs.label)},resetSelection(){this.activeSelection=[]},applySelection(){this.toggleDropdown()},handleSelection(t){if(!this.activeSelection.includes(t))this.activeSelection.push(t);else{const e=this.activeSelection.indexOf(t);this.activeSelection.splice(e,1)}this.$emit(f.DROPDOWN_CHANGED,this.activeSelection)},toggleDropdown(){this.isOpen=!this.isOpen,this.isOpen?(this.$emit(f.DROPDOWN_OPENED,this),this.modalOpened()):(this.resetFilterText(),this.modalClosed())},closeModal(){document.body.classList.remove("modal-open")},modalOpened(){n.isUpperBreakpoint()||document.body.classList.add("modal-open")},modalClosed(){n.isUpperBreakpoint()||this.closeModal()},toggleIconClasses(t){return["dropdown__toggle-icon",this.activeSelection.includes(t)?l.ACTIVE:""]},handleMouseEnter(t){if(!n.isUpperBreakpoint())return t.preventDefault();this.toggleDropdown()},handleMouseDown(t){if(!n.isUpperBreakpoint())return t.preventDefault();this.toggleDropdown()},handleClick(t){if(n.isUpperBreakpoint())return t.preventDefault();this.toggleDropdown()},getCheckboxId(t,e){return`dropdown-checkbox-${t.value}-${e}`},resetFilterText(){this.filterText=""},resetModal(){this.isOpen=!1,this.closeModal()},handleResize(){this.resetModal()}},beforeMount(){var e;const t=(e=window.i18n)==null?void 0:e.loader;t&&t.then(()=>{var s;this.translationData=(s=window.i18n)==null?void 0:s.getTranslationData(["search","apply","reset"])}),this.initActiveSelection()},mounted(){this.updateUtilityAnimation(),window.addEventListener("resize",this.handleResize)},beforeDestroy(){window.removeEventListener("resize",this.handleResize)},data(){return{activeSelection:[],isOpen:!1,filterText:"",minCharsToFilter:1}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Je=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"event",data(){return{hasMultipleDays:!1}},computed:{style(){return`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Ze=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"fab-hint",data(){return{expaned:!1,translationData:{}}},computed:{classList(){return["fab-hint vue-component",this.expaned?l.EXPANDED:""]},options(){return`{
      ...
      }`},containerStyle(){return{...this.bgColor?{"--fab-hint-bg-color":this.bgColor}:{},...this.iconColor?{"--fab-hint-icon-color":this.iconColor}:{}}},iconValue(){return this.icon||"image-credits"},titleValue(){var t;return this.title||((t=this.translationData)==null?void 0:t.imageCredits)},enhancedText(){if(!this.text)return"";const e=new DOMParser().parseFromString(this.text,"text/html");return e.querySelectorAll("a").forEach(s=>s.classList.add("is-basic-link")),e.body.innerHTML}},beforeMount(){var e;const t=(e=window.i18n)==null?void 0:e.loader;t&&t.then(()=>{var s;this.translationData=(s=window.i18n)==null?void 0:s.getTranslationData(["imageCredits"])})},mounted(){this.addObserver()},methods:{addObserver(){new MutationObserver(e=>{e.forEach(s=>{var i,r;s.attributeName==="style"&&(this.isVisible((r=(i=s==null?void 0:s.target)==null?void 0:i.style)==null?void 0:r.cssText)||this.handleClose())})}).observe(this.$el,{attributes:!0,attributeFilter:["style"]})},isVisible(t){return t!==""},handleClick(){this.expaned=!this.expaned},handleClose(){this.expaned=!1}},props:{icon:String,iconColor:String,bgColor:String,text:String,title:String},template:`
    <div :class="classList">
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Ke=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"faq",data(){return{entriesWithState:[]}},beforeMount(){var t;this.entriesWithState=(t=this.entries)==null?void 0:t.map((e,s)=>(e.isOpen=null,e.isDetailsOpen=null,e.height=null,e.index=s,e.id=`entry-${s}`,e))},computed:{style(){return this.index?`--utility-animation-index: ${this.index}`:null},classList(){return["faq","utility-animation","container space-top-2","vue-component"]},headlineClasses(){var t;return`faq__headline fade-in-bottom ${(t=this.headline)!=null&&t.classes?this.headline.classes:""}`},headlineLevel(){var t;return(t=this.headline)!=null&&t.level?this.headline.level:"h2"}},methods:{getDelay(t){const e=t.index>0?200:0;return`--utility-animation-delay: ${`${t.index*e}ms`};`},handleClick(t){t.isOpen=t.isOpen===null?!0:null,t.isOpen&&(t.isDetailsOpen=!0)},getElementByRef(t){const e=this.$refs[t==null?void 0:t.id];if(!(!e||e.length===0))return e[0]},afterLeave(t){const e=this.getElementByRef(t);e&&(t.isDetailsOpen=null,e.style.removeProperty("display"),e.style.removeProperty("height"),e.classList.remove(l.IS_COLLAPSING))},enter(t){const e=this.getElementByRef(t);if(!e)return;const s=e.offsetHeight;e.style.removeProperty("height"),e.style.height=0,e.style.paddingTop=0,e.style.paddingBottom=0,e.style.marginTop=0,e.style.marginBottom=0,setTimeout(()=>{e.style.height=`${s}px`,e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.removeProperty("margin-top"),e.style.removeProperty("margin-bottom")})},leave(t){const e=this.getElementByRef(t);if(!e)return;const s=e.offsetHeight;e.classList.add(l.IS_COLLAPSING),setTimeout(()=>{e.style.height=`${s}px`})}},props:{headline:Object,entries:Array,index:Number},template:`
    ...
    </div>`}},Symbol.toStringTag,{value:"Module"})),Ye=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"feature-list",data(){return{defaultIcon:"check"}},computed:{classList(){return["feature-list container space-2 vue-component"]},itemsWithFallback(){const t=[];return this.items.forEach(e=>{const s=e.icon?e.icon:this.defaultIcon,i=s===this.defaultIcon,r=i?"var(--color-blue-jeans)":e.color,a=i,o=i?!0:e.circle,c=i?"medium":e.size,d=e.bullet,h={icon:s,color:r,hasBackground:a,circle:o,size:c,bullet:d};t.push(h)}),t}},methods:{},props:{items:{default:null}},template:`
    <div :class="classList">
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Qe=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"filter-bar",computed:{flatSelections(){return this.selections.flat()},storedItems(){return this.$root.StoreData.blogItems?this.$root.StoreData.blogItems():[]},dataAuthorsValue(){return n.getJSON(this.dataAuthors)},normalizedItems(){return this.storedItems.slice(this.itemStartPoint).map(t=>({...t,blogtitlepic:`${t.blog_image_path}${t.blogtitlepic}`}))},filteredItems(){if(!this.selections.length)return this.maxBlogPosts?this.normalizedItems.slice(0,this.maxBlogPosts):this.normalizedItems;let t=[];return this.selections.forEach(e=>{e.forEach(s=>{this.filterDropdowns.forEach(i=>{const r=i.key,a=this.normalizedItems.filter(o=>Array.isArray(o[r])?o[r].includes(s.value):o[r]===s.value);t=[...t,...a]})})}),this.getMaxItems(t)},authors(){return this.extractPropertyCounts("author")},topics(){return this.extractPropertyCounts("categories")},tags(){return this.extractPropertyCounts("tags")},dropdownCollection(){return[this.authors,this.topics,this.tags]}},created(){this.$root.StoreData.blogItems=this.$root.Store(n.getJSON(this.items)),this.$root.StoreData.blogView=this.$root.Store(this.activeView)},beforeMount(){var e;const t=(e=window.i18n)==null?void 0:e.loader;t&&t.then(()=>{var s,i,r,a;this.translationData=(s=window.i18n)==null?void 0:s.getTranslationData(["onlyLanguage","filterAuthors","filterTopics","filterTags","clearAll"]),this.filterDropdowns=[{label:(i=this.translationData)==null?void 0:i.filterAuthors,items:this.authors,key:"author"},{label:(r=this.translationData)==null?void 0:r.filterTopics,items:this.topics,key:"categories"},{label:(a=this.translationData)==null?void 0:a.filterTags,items:this.getFilteredTags(),key:"tags",filterable:!0}]})},mounted(){window.addEventListener("resize",this.handleResize),this.handleResize()},beforeDestroy(){window.removeEventListener("resize",this.handleResize)},methods:{getFilteredTags(){const t=n.getHash();if(!t)return this.tags;const e=decodeURIComponent(t.substring(1)).toLowerCase();return this.tags.map(i=>i.text.toLowerCase()===e?(this.addTagToSelection(i),{...i,checked:!0}):i)},addTagToSelection(t,e){const s=e||this.dropdownCollection.length-1;this.selections[s]=[t]},getMaxItems(t){return t=[...new Set(t)],this.maxBlogPosts?t.slice(0,this.maxBlogPosts):t},handleResize(){this.itemStartPoint=n.isUpperBreakpoint()?1:0},extractPropertyCounts(t){return this.normalizedItems.reduce((s,i)=>(Array.isArray(i[t])?i[t].forEach(r=>{this.updatePropertyCount(s,r)}):this.updatePropertyCount(s,i[t]),s),[]).sort((s,i)=>s.text.localeCompare(i.text))},updatePropertyCount(t,e){const s=t.find(i=>i.text.toLowerCase()===e.toLowerCase());s?s.count+=1:t.push({text:e,value:e,count:1})},handleView(t){this.activeView=t,this.$root.StoreData.blogView(this.activeView)},toggleIconClasses(t){return["filter-bar__toggle-icon",t===this.activeView?l.ACTIVE:""]},isArrayEmpty(t){return!Object.keys(t).length},isArrayEmptyRecursive(t){for(let e=0;e<t.length;e++){const s=t[e];if(s&&!this.isArrayEmpty(s))return!1}return!0},handleCardTagClicked(t){this.clearAllSelections(),this.getTagByName(t.toLowerCase())},getTagByName(t){this.tags.map(e=>{if(e.text.toLowerCase()===t){const s=this.filterDropdowns.length-1;this.addTagToSelection(e,s),this.updateDropdownSelection([e],s),this.hasClickedOnTag=!0}})},handleDropdownChange(t,e){t.length===0?this.selections[e]&&delete this.selections[e]:(this.hasClickedOnTag&&(this.hasClickedOnTag=!1,this.selections[e]=[]),this.selections[e]=t),this.isArrayEmptyRecursive(this.selections)&&(this.selections=[])},handleDropdownOpened(t){this.$refs.dropdowns.forEach(e=>{e!==t&&(e.isOpen=!1)})},clearAllSelections(){this.selections=[],this.$refs.dropdowns.forEach(t=>{t.isOpen=!1,t.activeSelection=[]})},removeSelection(t,e){if(t.preventDefault(),this.selections=this.selections.map(i=>i.filter(r=>r.value!==e.value)),this.selections.forEach((i,r)=>{this.updateDropdownSelection(i||[],r)}),this.selections.filter(i=>i.length>0).length===0)return this.clearAllSelections()},updateDropdownSelection(t,e){const s=this.$refs.dropdowns[e];s&&(s.activeSelection=t)}},data(){return{activeView:"tile-view",views:["tile-view","list-view"],filterDropdowns:[],selections:[],itemStartPoint:0,hasClickedOnTag:!1}},props:{spacing:String,items:String,maxBlogPosts:Number,dataAuthors:String},template:`
  ...
  `,props:{items:Array,bgColor:String}}},data(){return{bgColorRgbaValue:null}},computed:{classList(){return["footer text-white",n.isTrue(this.noMargin)?"":"mt-8 mt-lg-11",this.isCorporate?"footer--corporate":"","vue-component"]},isCorporate(){var t;return!((t=this.dataValue)!=null&&t.brandLogos)},style(){var t;return[(t=this.dataValue)!=null&&t.bgColor?`background-color: ${this.dataValue.bgColor};`:""]},dataValue(){return this.data?{...de,...n.getJSON(this.data)}:{...de}},links(){const t=this.lang.toLowerCase();if(t==="de"||t==="")return this.dataValue.links;{const e=n.capitalize(this.lang),s=this.dataValue[`links${e}`];return s||this.dataValue.links}},locations(){const t=[];return t.push({name:this.dataValue.name,street:this.dataValue.street,postalCode:this.dataValue.postalCode,city:this.dataValue.city,country:this.dataValue.country,mail:this.dataValue.mail}),this.dataValue.additionalLocations&&this.dataValue.additionalLocations.length&&t.push(...this.dataValue.additionalLocations),t}},mounted(){this.bgColorRgbaValue=this.bgColorRgba()},methods:{bgColorRgba(){if(!this.$refs.root)return null;const s=window.getComputedStyle(this.$refs.root).getPropertyValue("background-color").replace(/[^\d,]/g,"").split(",");return`rgba(${s[0]}, ${s[1]}, ${s[2]}, 1)`}},props:{data:Object,noMargin:{default:null},lang:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),tt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"form-attachments",data(){return{isDragging:!1,hasError:!1,filesLength:0,files:new DataTransfer}},computed:{filesList(){if(!this.files.files)return null;const t=Array.from(this.files.files);return this.filesLength>this.maxFilesValue?t.slice(0,this.maxFilesValue):t},classList(){return["form-attachments",this.hasError===!0?"has-error":"",this.isDragging?l.DRAGGING:"","vue-component"]},interactableClassList(){return["form-attachments__interactable",this.hasErrors?l.HAS_ERROR:""]},required(){return this.required?"required":null},maxSizeMb(){return this.maxSize/1e6},maxFilesValue(){return this.maxFiles?this.maxFiles:5},extensionCollection(){return this.extensions.split?this.extensions.split(","):this.extensions},extensionList(){const t=this.extensionCollection.map(e=>n.capitalize(e));return t==null?void 0:t.join(", ")},extensionListText(){return`${this.extensionList} max. ${this.maxSizeMb} MB`},acceptList(){return this.extensionCollection.map(t=>`.${t}`).join(",")}},props:{hasError:{default:null},maxSize:Number,description:String,text:String,requiredMsg:{default:null},required:{default:null},extensions:String,id:String,maxFiles:Number},mounted(){var t,e;this.root=this.$refs.root,this.interactable=this.$refs.interactable,this.button=this.$refs.button,this.textElement=this.$refs.text,this.file=this.$refs.file,this.error=this.$refs.error,this.base64=this.$refs.base64,this.bindEvents(),(e=(t=window.i18n)==null?void 0:t.loader)==null||e.then(()=>{var s,i,r;this.wrongTypeText=(s=window.i18n)==null?void 0:s.translate("formAttachmentsWrongType"),this.maxFilesText=(i=window.i18n)==null?void 0:i.translate("formAttachmentsMaxFiles",this.maxFilesValue),this.maxSizeText=(r=window.i18n)==null?void 0:r.translate("formAttachmentsMaxSize")})},methods:{bindEvents(){this.interactable.addEventListener("drag",this.handleDragStart.bind(this)),this.interactable.addEventListener("dragstart",this.handleDragStart.bind(this)),this.interactable.addEventListener("dragover",this.handleDragOver.bind(this)),this.interactable.addEventListener("dragenter",this.handleDragOver.bind(this)),this.interactable.addEventListener("drop",this.handleDrop.bind(this)),this.interactable.addEventListener("dragleave",this.handleDrop.bind(this)),this.interactable.addEventListener("dragend",this.handleDrop.bind(this)),this.interactable.addEventListener("click",this.handleAddAttachment.bind(this)),document.addEventListener(f.FORM_ATTACHMENT_ERROR,this.handleFormAttachmentError.bind(this));const t=n.getParent(this.root,"form");t&&t.addEventListener("reset",this.reset.bind(this))},handleFormAttachmentError(t){this.showError(this.maxSizeText)},handleDragStart(t){t.preventDefault(),t.stopPropagation()},handleDragOver(t){t.preventDefault(),t.stopPropagation(),window.clearTimeout(this.dropTimeout),this.isDragging=!0},handleDrop(t){var s;t.preventDefault(),t.stopPropagation();const e=(s=t==null?void 0:t.dataTransfer)==null?void 0:s.files;this.dropTimeout=window.setTimeout(()=>{this.isDragging=!1,t.type==="drop"&&this.handleDroppedFiles(e)},50)},isAllowedFileExtension(t){var r;if(!t)return;const e=(r=this.file.getAttribute("accept"))==null?void 0:r.toLowerCase(),s=(e==null?void 0:e.split(","))||[],i=n.getExtension(t.name);return s.includes(`.${i}`)},isUnderMaxSize(t){if(!(!t||!t.size))return t.size<=this.maxSize},handleDroppedFiles(t){const e=this.getErrors(t);if(e)return this.showError(e);this.appendDroppedFiles(t)},handleAddAttachment(){this.file.click()},restoreDataTransfer(){this.file.files=this.files.files},showError(t){this.restoreDataTransfer(),this.setErrorText(t),this.hasError=!0},setErrorText(t){this.error&&(this.error.innerText=t)},reset(){this.file.files=null,this.files=new DataTransfer,this.resetError()},resetError(){this.setErrorText(this.requiredMsg),this.hasError=!1},appendDroppedFiles(t){this.base64&&(this.isRequired&&(this.file.required=!1),this.appendFiles(t))},areFilesAllowed(t){return Array.from(t).every(e=>this.isAllowedFileExtension(e))},getErrors(t){if(!this.areFilesAllowed(t))return this.wrongTypeText;if(this.files.files.length+t.length>this.maxFilesValue)return this.maxFilesText;if(!Array.from(t).every(e=>this.isUnderMaxSize(e)))return this.maxSizeText},appendFiles(t){if(this.files.files.length>=this.maxFilesValue)return this.showError(this.maxFilesText);Array.from(t).forEach(e=>{this.files.items.add(e)}),this.syncFiles()},syncFiles(){this.filesLength=this.files.items.length,this.file.files=this.files.files,this.resetError()},handleChange(t){var i;const e=(i=t==null?void 0:t.target)==null?void 0:i.files,s=this.getErrors(e);if(s)return this.showError(s);this.appendFiles(e)},handleClick(t){this.files.files[t]&&(this.files.items.remove(t),this.syncFiles())},toSize(t){return n.toSize(t)}},template:`
...
`}},Symbol.toStringTag,{value:"Module"})),ot=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"form-radios",computed:{otherId(){return`${this.radio.id}_radio`},required(){var t;return(t=this.radio)!=null&&t.required?"required":null},message(){return this.field.required?this.field.requiredMsg:null}},props:{field:Object,id:{default:null}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),nt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"form-select",computed:{required(){var t;return(t=this.field)!=null&&t.required?"required":null}},props:{options:Array,field:Object,id:String},template:`
    <label class="input-label" :for="id">{{field.label}}</label>
  ...
  `}},Symbol.toStringTag,{value:"Module"})),B={tagName:"formular",data(){return{originalAction:"",formAction:""}},computed:{classList(){var t;return["form",`${n.isTrue(this.light)===!0?"is-light":""}`,`${n.isTrue(this.ajax)===!0?"form--ajax":""}`,`${n.isTrue(this.container)===!0?"container":""}`,`${n.isTrue(this.customValidation)===!0?"form--custom-validation":""}`,((t=this.form)==null?void 0:t.noCustomSubmit)===!0?B.noCustomSubmitClass:"","vue-component"]},hasAnimationValue(){return n.isTrue(this.hasAnimation)},rowClassList(){return["form__row",`${this.container?"row":""}`]},wrapperClassList(){return[`${this.container?"col-md-11 col-lg-10":""}`]},headlineClassList(){return["container headline-row",`${this.space?this.space:"space-top-2"}`,this.hasAnimationValue?"utility-animation fade-in-bottom":""]},sublineClassList(){return["text-center",`${this.form.sublineClasses?this.form.sublineClasses:""}`]},formClassList(){return["form__submit mt-5",`${this.positionValue}`]},positionValue(){return this.form.ctaPosition?this.form.ctaPosition:n.isTrue(this.uncentered)?"":"justify-content-end"},method(){return this.form.method?this.form.method:"post"},preparedBlocks(){const t=[];let e=0,s=[];return this.form.fields.forEach(i=>{if(i.rowStart||i.rowEnd)i.rowStart?(t[e]=s,s.push(i),i.rowEnd&&(s=[],e++)):i.rowEnd&&(s.push(i),s=[],e++);else{if(s.push(i),t[e])return;t[e]=s,s=[],e++}}),t}},beforeMount(){this.originalAction=this.formAction=this.form.action},methods:{getOptions(t){return typeof t.options=="string"?this.options[t.options]:t.options},getBlockClassList(t){return["row mx-n3",`${t!=null&&t.rowClass?t.rowClass:""}`]},getFieldClassList(t){return["px-3",`${t.col?"col-md-"+t.col:"col-md-12"}`]},getId(t){const e=(t==null?void 0:t.radios)||(t==null?void 0:t.checkboxes),s=e?e[0].id:t==null?void 0:t.id;return n.isTrue(this.hasUuid)?B.getId(s):s},updateAction(t){t?this.formAction=t:this.formAction=this.originalAction}},props:{form:Object,light:{default:null},analytics:{default:null},space:String,container:{default:null},ajax:{default:null},uncentered:{default:null},replaceValue:{default:null},customValidation:{default:null},options:Object,hasUuid:{default:null},hasAnimation:{default:null}},template:`
    <div :class="classList">
  ...
  `},lt=Object.freeze(Object.defineProperty({__proto__:null,default:B},Symbol.toStringTag,{value:"Module"})),ct=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"google-map-entry",computed:{classList(){return["google-map-entry media vue-component",this.icon==="phone-charger"?"":"mb-5"]}},props:{icon:String,headline:String,subline:String},template:`
    <div :class="classList">
  ...
  `}},Symbol.toStringTag,{value:"Module"})),dt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"google-map",computed:{classList(){return["google-map position-relative mx-3 mx-md-8 vue-component"]},leafletOptions(){var i;const t=this.location.coordinates,e=[50,45],s={map:{scrollWheelZoom:!1,coords:t},marker:[{coords:t,icon:{iconUrl:n.getAssetPath("svg/icons/map-pin.svg"),iconSize:e},popup:{text:this.location.street+", "+this.location.city,title:(i=window.i18n)==null?void 0:i.translate("address")}}]};return JSON.stringify(s)}},mounted(){this.loadMap()},methods:{loadMap(){var s,i;const t=this.$refs.map,e=(i=(s=$==null?void 0:$.HSCore)==null?void 0:s.components)==null?void 0:i.HSLeaflet;e===null||L===null||e.init(t)}},props:{location:{default:null},entries:{default:null}},template:`
  <div :class="classList">
  ...
  `}},Symbol.toStringTag,{value:"Module"})),ht=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"grid-list",computed:{classList(){return["grid-list row mb-3 utility-animation__group vue-component"]},columnClassList(){return[this.view==="tile-view"?"col-sm-6 col-lg-4":"col-sm-6 col-lg-12","mb-3 mb-sm-8"]},isList(){return this.view==="list-view"},isRow(){return!!this.isList}},watch:{view(){this.resetUtilityAnimation()},items(){this.itemsChanged=!0}},created(){},updated(){this.itemsChanged&&(this.itemsChanged=!1,this.reinitUtilityAnimation())},methods:{resetUtilityAnimation(){setTimeout(()=>{j.resetGroup(this.$refs.group)},100)},reinitUtilityAnimation(){!this.$refs.items||!this.$refs.items.length===0||(j.instances=[],j.init(Array.from(this.$refs.items)),j.addObserver())},blogImgUrl(t){const e="blog/heads/";return t.includes(e)?t:`${e}${t}`},handleCardTagClicked(t){this.$emit(f.CARD_TAG_CLICKED,t)}},props:{items:String,view:String,dataAuthors:Array},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),pt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"grid",computed:{headlineLevelValue(){return this.headlineLevel?this.headlineLevel:"h2"},headlineClassesValue(){return`grid__headline ${this.headlineClasses?this.headlineClasses:"h3-font-size"}`},style(){const t=n.isTrue(this.light)?"var(--color-copy-light)":null;return{backgroundColor:this.bgColor,"--color-copy":t,"--color-headlines":t}},itemsValue(){return n.getJSON(this.items)}},methods:{getItemStyle(t){return j.getIndexStyle(t)}},props:{items:String,headline:String,headlineLevel:String,headlineClasses:String,light:{default:!1},bgColor:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),ut=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"v-header",computed:{classList(){return["header",this.isScrolled?l.IS_SCROLLED:"",this.isLight?"header--light":"",n.isTrue(this.hover)?l.HOVERING:"",n.isTrue(this.product)?"header--product":"",n.isTrue(this.closed)?"":l.EXPANDED,n.isTrue(this.blendMode)?"header--blending":"","vue-component"]},headerContainerClassList(){return["header__container",this.containerClass]},containerClass(){return n.isTrue(this.product)?"container":"container-xxl"},homeObj(){var t;return(t=this.home)==null?void 0:t.languages[this.lowerLang]},lowerLang(){return this.lang.toLowerCase()},searchValue(){return n.isTrue(this.search)},metaList(){return{...this.meta,children:this.meta}},spacerBgColor(){return`--color-header-spacer-background: ${this.bgColor?this.bgColor:"var(--color-header-background)"}; background-color: var(--color-header-spacer-background);`},activeNavigation(){return this.setActiveLinks(),this.navigation},isLight(){return n.isTrue(this.light)===!0},hasLangSwitch(){var t;return Object.keys((t=this.home)==null?void 0:t.languages).length>1},hasContact(){return this.contact},hasMeta(){return this.meta&&this.meta.length>0}},mounted(){this.bindEvents(),this.setCtaClasses(),this.setLinkWidth()},updated(){this.inUpdate&&(this.updateProductListHeight(),this.inUpdate=!1,this.inTransition=!1)},methods:{setLinkWidth(){var e;const t=this.$refs.link;if(t)for(let s=0;s<t.length;s++){const i=t[s],r=(e=i.querySelector(".header__link-text-spacer"))==null?void 0:e.clientWidth;i.style.setProperty("--header-link-text-width",r+"px")}},showFlyoutBlock(t){return!(t.length>this.maxLinkListsInFlyout)},isLowerBreakpoint(){return n.isBelowBreakpoint("md")},bindEvents(){window.addEventListener("scroll",this.handleScroll.bind(this)),document.addEventListener(f.WINDOW_RESIZE,this.handleResize.bind(this))},handleResize(){this.reset(),this.setLinkWidth()},handleScroll(){this.isScrolled=window.scrollY>this.scrollThreshold,this.setCtaClasses()},reset(){this.resetFlyouts(),this.updateProductListHeight(),this.closed=!0},handleCloseClick(){this.closed=!this.closed,this.closed&&this.reset()},resetFlyouts(){Object.keys(this.linkLists).forEach(t=>{this.linkLists[t]=!1})},handleClick(t,e){if(!this.isLowerBreakpoint())return;const s=this.getId(t,e);this.linkLists[s]=!this.linkLists[s],this.linkLists[s]&&(this.inTransition=!0),this.inUpdate=!0,this.closeAllSiblings(s),this.closeAllChildren()},closeAllSiblings(t){Object.keys(this.linkLists).forEach(s=>{s!==t&&(this.linkLists[s]=!1)})},closeAllChildren(){const t=new CustomEvent(f.CHILD_HAS_UPDATE,{detail:{}});this.$refs.list.dispatchEvent(t)},getId(t,e){return`${t.name}_${e}`},handleHeaderMouseOver(){this.hoverHeader=!0,this.setCtaClasses()},handleHeaderMouseOut(){this.hoverHeader=!1,this.setCtaClasses()},setCtaClasses(){this.isLight&&(this.hoverHeader||this.isScrolled?this.ctaClassList=!1:this.ctaClassList="is-light-lg")},handleMouseOver(t,e){if(!t.children)return;this.resetAllFlyouts(),this.hover=!0;const s=this.getLinkRef(e);if(!s)return;s.classList.add(l.EXPANDED);const i=this.getFlyoutRef(e);i&&(this.flyoutIndex=e,i.classList.add(l.EXPANDED))},handleMouseOut(t){var i;if((i=t.relatedTarget)!=null&&i.closest(".header__flyout"))return;this.hover=!1;const e=this.getLinkRef(this.flyoutIndex);if(!e)return;e.classList.remove(l.EXPANDED);const s=this.getFlyoutRef(this.flyoutIndex);s&&s.classList.remove(l.EXPANDED)},handleLanguageOver(){this.resetAllFlyouts(),this.hover=!0;const t=this.$refs.languageSwitch;t&&t.classList.add(l.EXPANDED)},handleLanguageOut(t){var s;if((s=t.relatedTarget)!=null&&s.closest(".header__flyout"))return;this.hover=!1;const e=this.$refs.languageSwitch;e&&e.classList.remove(l.EXPANDED)},resetAllFlyouts(){var t,e;(t=this.$refs.link)==null||t.forEach(s=>{s.classList.remove(l.EXPANDED)}),(e=this.$refs.flyout)==null||e.forEach(s=>{s.classList.remove(l.EXPANDED)})},getFlyoutRef(t){return this.getRef("flyout",t)},getLinkRef(t){return this.getRef("link",t)},getRef(t,e){const s=this.$refs[t][e];if(s)return s},getHref(t){var e;return t.children?"javascript:void(0);":(e=t.languages[this.lowerLang])==null?void 0:e.url},getTarget(t){var s;const e=(s=t.languages[this.lowerLang])==null?void 0:s.target;return e||null},getNextLanguage(){const t=this.home.languages;if(!t)return;const e=Object.keys(t);if(!e.length)return;const s=e.filter(i=>i!==this.lowerLang);if(s.length)return s[0]},handleLanguageSwitch(t){var i;const e=this.getActiveUrlByLang(t),s=e||((i=this.home.languages[t])==null?void 0:i.url);n.storageSave("preferedLanguage",t,!1),document.location.href=s},getCurrentPath(){return document.location.pathname},getActiveUrlByLang(t,e){var c;const s=this.getCurrentPath(),i="/",r=(d,h)=>{if(!(d!=null&&d.title))return;let u=d==null?void 0:d.url;s[(s==null?void 0:s.length)-1]===i&&u&&u[(u==null?void 0:u.length)-1]!==i&&(u=u+i);const y=u===s;if(e&&y){d.active=!0;const M=this.getParentLink(h);M&&(M.active=!0)}return y},a=(d,h)=>h;let o=n.findRecursive(this.navigation,r,a);if(o||(o=n.findRecursive(this.meta,r,a)),o||(o=n.findRecursive(this.contact,r,a)),!o){const d=this.getHrefLang(t);return d||this.getTranslatedUrl(s,t)}return(c=o[t])==null?void 0:c.url},getTranslatedUrl(t,e){if(this.isBlogTagsUrl(t))return this.getBlogTagsUrl(e,t);const s=this.getFolderSwitchSegment(t);return s?this.getFolderSwitchUrl(e,t,s):null},getFolderSwitchSegment(t){const e=this.home.folderSwitch;return e&&e.find(i=>t.includes(i))||null},getFolderSwitchUrl(t,e,s){if(!s)return e;let i;if(t===this.defaultLang){const r=new RegExp(`/${this.lowerLang}/`);i=e.replace(r,"/")}else i=e.replace(s,`${t}/${s}`);return i},isBlogTagsUrl(t){return/\/blog\/tags/.test(t)},getBlogTagsUrl(t,e){let s;const i="tags";switch(t){case"en":s=e.replace(i,`${i}-${t}`);break;default:case this.defaultLang:const r=new RegExp(`${i}-..`);s=e.replace(r,i);break}return s+document.location.search},getHrefLang(t){const e=document.querySelector(`link[hreflang=${t}]`);if(e)return e.getAttribute("href")},getParentLink(t){return this.navigation[t].languages[this.lowerLang]},setActiveLinks(){this.getActiveUrlByLang(this.lowerLang,!0)},headerItemClasses(t){var e;return["header__item",(e=t.languages[this.lowerLang])!=null&&e.active?l.ACTIVE:""]},isLinkListHidden(t,e){const s=this.getId(t,e);return!this.linkLists[s]},headerLinkClasses(t,e){return this.getListClasses(t,e,["header__link custom"])},headerProductListClasses(t,e){return this.getListClasses(t,e,["header__product-list",this.inTransition?l.IN_TRANSITION:""])},getListClasses(t,e,s){const i=this.isLinkListHidden(t,e);return[...s,i?"":l.EXPANDED]},updateProductListHeight(){const t=this.$refs["product-list"];if(t)for(let e=0;e<t.length;e++){const s=t[e],r=!s.classList.contains(l.EXPANDED)||s.style.height!==""?"":s.scrollHeight+"px";s.style.height=r}},navHighlightClasses(t,e){return["header__nav-highlight custom",this.isLinkListHidden(t,e)?"is-hidden":""]},hasContactLink(t){var e,s;return((e=this.contact)==null?void 0:e.languages)&&!((s=t.languages[this.lowerLang])!=null&&s.emergency)}},props:{home:Object,navigation:Object,meta:Object,light:{default:null},search:{default:null},lang:String,contact:Object,bgColor:String,product:{default:null},button:{default:null},blendMode:{default:null}},data(){return{inUpdate:!1,inTransition:!1,defaultLang:"de",closed:!0,hover:!1,headerHover:!1,flyoutIndex:null,linkLists:{},scrollThreshold:10,isScrolled:!1,ctaClassList:!1,maxLinkListsInFlyout:3}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),mt=(t,e)=>{const s=t.__vccOpts||t;for(const[i,r]of e)s[i]=r;return s},gt={props:{text:String,level:String,classes:String,utilityAnimationStep:Number},computed:{tag(){return this.level?this.level:"h2"},classList(){return`${this.classes&&n.hasFontSizeClass(this.classes)?this.classes:`${this.tag}-font-size ${this.classes?this.classes:""}`} headline vue-component`},dataUtilityAnimationStep(){return this.utilityAnimationStep?this.utilityAnimationStep:null}}};function ft(t,e,s,i,r,a){return s.text?(g.openBlock(),g.createBlock(g.resolveDynamicComponent(a.tag),{key:0,class:g.normalizeClass(a.classList),innerHTML:s.text,"data-utility-animation-step":a.dataUtilityAnimationStep},null,8,["class","innerHTML","data-utility-animation-step"])):(g.openBlock(),g.createBlock(g.resolveDynamicComponent(a.tag),{key:1,class:g.normalizeClass(a.classList),"data-utility-animation-step":a.dataUtilityAnimationStep},{default:g.withCtx(()=>[g.renderSlot(t.$slots,"default")]),_:3},8,["class","data-utility-animation-step"]))}const vt=Object.freeze(Object.defineProperty({__proto__:null,default:mt(gt,[["render",ft]])},Symbol.toStringTag,{value:"Module"})),bt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"hero",components:{"hero-pattern":{tagName:"hero-pattern",template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),yt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"icon",data(){return n.validateVueProps(this)},computed:{classList(){return["icon",`${this.classes?this.classes:""}`,`${this.props.hasBackground?"icon--has-background":""}`,`icon--${this.props.direction}`,`icon--${this.props.icon}`,`${this.props.animation?"js-text-animation__icon":""}`,`${this.props.circle?"icon--circle":""}`,`${this.props.hover?"icon--hover":""}`,"vue-component"]},innerSize(){var t;switch(this.props.size){case"xxl":t="200px";break;case"xl":t="120px";break;case"medium":t="28px";break;case"small":t="18px";break;case"xs":t="10px";break;default:case"large":t="48px";break}return t},parentStyle(){return`--color-icon: ${this.props.color}; --icon-rotation: ${this.rotation}`},rotation(){return this.props.direction==="left"?"180deg":this.props.direction==="clockwise"?"90deg":"0deg"},settings(){return{width:this.innerSize,height:this.innerSize,padding:this.props.padding,"xml:space":"preserve",version:"1.1",xmlns:"http://www.w3.org/2000/svg","xmlns:link":"http://www.w3.org/1999/xlink"}}},props:{icon:{default:"close"},color:{default:"currentColor"},direction:{default:"right"},size:{default:"large"},circle:{default:null},hover:{default:null},padding:{default:6},animation:{default:null},classes:{default:""},closed:{default:null},hasBackground:{default:null},step:{default:null}},template:`
    ...
    `}},Symbol.toStringTag,{value:"Module"})),_t=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"arrow-curl",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),St=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"arrow-external",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Ct=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"arrow-narrow",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),kt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"arrow",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),wt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"bin",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale)); stroke-linecap:round; stroke-linejoin:round;`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),xt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"check",computed:{style(){return`fill: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
    <svg v-bind="settings" :style="style" viewBox="0 0 512 512">
      <path d="M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z" />
    </svg>
  `}},Symbol.toStringTag,{value:"Module"})),ae=48,Lt={tagName:"close",computed:{outerPosition(){return ae-this.padding},style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{padding:String,viewBoxWidth:String,settings:Object,color:String},template:`
    <svg v-bind="settings" :style="style" viewBox="0 0 ${ae} ${ae}">
  ...
  `}},Symbol.toStringTag,{value:"Module"})),jt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"email-action-unread",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)); fill: none; stroke-linecap: round; stroke-linejoin: round`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Ot=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"emergency",computed:{style(){return`fill: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Et=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"expand",computed:{style(){return"transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));"},stroke(){return this.color}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),he="0s",H="0.5s",O="0.3s",G="2",re="2s",Pt={tagName:"hand",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`},stroke(){return this.color}},props:{settings:Object,color:String},template:`
  <svg v-bind="settings" :style="style" viewBox="0 0 308 304" fill="none">
    ...
    <animateTransform id="hand-movement" href="#hand-outline" attributeName="transform" type="translate"
      ...
      begin="0s;set-hand-rotation.end+0s" dur="${H}"
      repeatCount="${G}"
      additive="sum"
    />
  ...
  `}},Symbol.toStringTag,{value:"Module"})),It=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"info",computed:{style(){return"transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));"},fill(){return this.color}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),$t=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"list-view",computed:{style(){const t=this.color?this.color:"#5CBBFF";return`fill: ${t}; stroke: ${t}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),qt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"magnifier",computed:{style(){return"transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));"},fill(){return this.color}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),zt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"mail",computed:{style(){return`fill: ${this.color}; transform: rotate(var(--icon-rotation)) scale(1.5);`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Bt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"meerkat",computed:{style(){return"transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));"}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Ft=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"minus",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`},stroke(){return this.color}},props:{settings:Object,color:String},template:`
    <svg v-bind="settings" :style="style" viewBox="0 0 24 24" fill="none">
      <path d="M23 12H1" stroke="#000520" stroke-linecap="round"/>
    </svg>
 `}},Symbol.toStringTag,{value:"Module"})),Rt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"phone-charger",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation));`}},props:{settings:Object,color:String},template:`
  <svg v-bind="settings" :style="style" viewBox="0 0 26 26">
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Ut=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"phone-mail",computed:{style(){return`fill: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Ht=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"phone",computed:{style(){return`stroke: ${this.color}; fill: none; transform: rotate(var(--icon-rotation)); stroke-linecap: round; stroke-linejoin: round; `}},props:{settings:Object,color:String},template:`
  <svg v-bind="settings" :style="style" viewBox="0 0 26 26">
    <g>
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Gt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"pin",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)); fill: none; stroke-linecap: round; stroke-linejoin: round;`}},props:{settings:Object,color:String},template:`
  <svg v-bind="settings" :style="style" viewBox="0 0 26 26">
    <g>
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Wt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"plus-minus",computed:{effectiveKeySplines(){return"0.19 1 0.2 1"},style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},updated(){this.animate(this.closed)},mounted(){this.animate(this.closed,!0)},methods:{animate(t,e){const s=[];this.$refs.svg.querySelectorAll("animate, animateTransform").forEach(r=>{(!t&&!r.classList.contains("closed")||t&&r.classList.contains("closed"))&&s.push(r)});const i=e?"beginElementAt":"beginElement";s.forEach(r=>{r[i](1e3)})}},props:{settings:Object,color:String,closed:Boolean},data(){return{duration:"0.35s",begin:"indefinite",keyTimes:"0;1"}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Jt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"plus",computed:{style(){return"transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));"},stroke(){return this.color}},props:{settings:Object,color:String},template:`
    <svg v-bind="settings" :style="style" viewBox="0 0 24 24" fill="none">
      <path d="M12 1V23" stroke="#000520" stroke-linecap="round"/>
      <path d="M23 12H1" stroke="#000520" stroke-linecap="round"/>
    </svg>
 `}},Symbol.toStringTag,{value:"Module"})),Zt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"quotes",computed:{style(){return`fill: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Kt=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"rocket",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),k="indefinite",Xt={tagName:"smile",computed:{style(){return`stroke: ${this.color}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},data(){return{"step-1":[],"step-2":[],"step-3":[]}},props:{settings:Object,color:String,step:Number},watch:{step(){this.startStep()}},methods:{setElementRef(t,e){const s=this["step-"+e];!t||s.includes(t)||s.push(t)},startStep(){const t=this["step-"+this.step];[].forEach.call(t,e=>{e.setAttribute("begin","0s"),e.beginElement()})}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),es=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"tile-view",computed:{style(){return`fill: ${this.color?this.color:"#5CBBFF"}; transform: rotate(var(--icon-rotation)) scale(var(--icon-scale));`}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),ts=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"world",computed:{style(){return"scale(var(--icon-scale));"},stroke(){return this.color}},props:{settings:Object,color:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),is=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"image-block",computed:{classList(){return["image-block space-2"]},imageWithCloudinary(){return{img:this.imageBlock.image,cloudinary:!0,alt:this.imageBlock.alt}}},props:{imageBlock:{default:null}},template:`
    <wrapper :classes="classList">
      <div class="mx-auto">
        <v-img v-bind="imageWithCloudinary" />
      </div>
    </wrapper>
  `}},Symbol.toStringTag,{value:"Module"})),as=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"image-list",computed:{imagesObject(){return this.images?JSON.parse(this.images):[]}},props:{images:Array},template:`
    ...
    </div>`}},Symbol.toStringTag,{value:"Module"})),rs=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"img-filter",props:{img:String,alt:String,cloudinary:{default:null},lazy:Boolean,classes:String,color:String},computed:{cloudinaryValue(){return n.isTrue(this.cloudinary)},colorValue(){return this.color?this.color:"#000520"},svgFilter(){const t=parseFloat((n.red(this.colorValue)/255).toFixed(5)),e=parseFloat((n.green(this.colorValue)/255).toFixed(5)),s=parseFloat((n.blue(this.colorValue)/255).toFixed(5)),i=1,r=Math.max(t,e,s),a=Math.min(t,e,s),o=100*(r+a)/2+"%",c="img-to-color";return`
  ...
  `}},Symbol.toStringTag,{value:"Module"}));class pe{constructor(e,s){this.root=e,this.maxShapes=3,this.loadingClass="loading",this.shapeClass="loading__shape",this.bounceClasses={up:"loading--bounce-up",down:"loading--bounce-down"},this.types=["circle","square","triangle","triangle-2","rectangle"],this.colors=["--color-loading--1","--color-loading--2","--color-loading--3","--color-loading--4"],this.currentColors={},this.maxRuns=20,this.scaleMin=4,this.scaleMax=5,this.rotationMin=90,this.rotationMax=270,this.animationInterval=800,this.intervals=[],this.hasShapes=!1,this.init(s)}getRandomColor(e){let s=this.colors[Math.floor(Math.random()*this.colors.length)];return e<this.maxRuns&&this.currentColors[s]&&(e++,s=this.getRandomColor(e)),s}getRandomType(){return this.types[Math.floor(Math.random()*this.types.length)]}getRandomTypeClass(){return`loading__shape--${this.getRandomType()}`}getRandomScale(){return Math.floor(Math.random()*(this.scaleMax-this.scaleMin+1))+this.scaleMin}getRandomRotation(){return Math.floor(Math.random()*(this.rotationMin-this.rotationMax+1))+this.rotationMin}getRandomOffset(){let e=Math.random()*6-2;return`${e>=0?"+ ":"- "}${e}`}getRandomStyle(){const e=this.getRandomColor();return{style:`
      left: calc(50% ${this.getRandomOffset()}vw);
      --color-loading: var(${e});
      --loading-scale: ${this.getRandomScale()}vh;
      --loading-rotation: ${this.getRandomRotation()}deg
    `,color:e}}createShapes(){for(var e=0;e<this.maxShapes;e++){const s=document.createElement("shape"),i=n.append(this.root,s);this.startAnimation(i)}}startAnimation(e){this.intervals.push(setInterval(()=>{const s=this.getRandomStyle();this.currentColors[s.color]=!0,e.className="",e.classList.add(this.getRandomTypeClass()),e.classList.add(this.shapeClass),e.setAttribute("style",s.style),e.classList.contains(this.bounceClasses.up)?e.classList.replace(this.bounceClasses.down,this.bounceClasses.up):e.classList.add(this.bounceClasses.up),setTimeout(()=>{e.classList.replace(this.bounceClasses.up,this.bounceClasses.down),this.currentColors[s.color]=!1},this.animationInterval/2)},this.animationInterval))}init(e){if(e&&typeof e=="function")return e();this.root.classList.add(this.loadingClass)}on(e){this.hasShapes||(this.hasShapes=!0,this.createShapes()),e!==!0&&this.root.classList.add(l.LOADING)}clear(){this.intervals.forEach(e=>{clearInterval(e)})}off(e,s){e?this.clear():setTimeout(()=>{this.clear(),s!==!0&&this.root.classList.remove(l.LOADING)},100)}}const os=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"job-list-detail",computed:{classList(){return["job-list__detail page-detail",`${this.hasLoading?l.LOADING:""}`,`${this.hasLoader?"loading":""}`,`${this.hideLoading?l.HIDE_LOADING:""}`,`${this.hasBack?"page-detail--has-back":""}`,"vue-component"]},headlineClassList(){return`job-list__detail-headline page-detail__headline ${this.headlineClasses?this.headlineClasses:""}`},headlineLevelValue(){return this.headlineLevel?this.headlineLevel:"h1"},style(){return`--page-detail-color: var(${this.color}); --color-icon-hover-color: var(--page-detail-color)`},color(){return this.detailColor?this.detailColor:"--color-job-list-detail"},baseData(){return this.base?JSON.parse(this.base):{}},getUuid(){return"job-list-detail-style"}},mounted(){this.loading=new pe(this.$refs["job-list-detail"],()=>{this.hasLoader=!0}),this.loading.on(!0),this.init()},data(){return{loadingDelay:300,sleepDelay:1300,loading:{},hasLoading:!0,hasLoader:!1,hideLoading:!1,api:{},hasBack:!1,entryData:{},personQuote:null,videoInner:null,jobIdValue:null}},methods:{init(){var r;const t=this.mockApplyUrl,e=this.mockDocumentsUrl;this.api=new te({...this.apiUrl&&{apiUrl:this.apiUrl},client_name:this.clientName,apiKey:this.apiKey,mockApplyUrl:t,mockDocumentsUrl:e}),this.api.setLang(n.getLang());const s=this.api.getJobId()||this.jobId;this.jobIdValue=s,this.showBackButton();const i=(r=window.i18n)==null?void 0:r.loader;i?i.then(()=>{this.loadJob()}):this.loadJob()},showBackButton(){document.referrer.indexOf(document.location.host)!==-1&&(this.hasBack=!0)},loadJob(){var t;this.loadLocalJobData(),(t=this.api)==null||t.getOpening(this.jobIdValue).then(e=>e.json()).then(e=>{this.handleJob(e)}).catch(e=>{console.error("Job-list Error:",e)})},handleCta(){var t;R.open((t=this.$refs["modal-component"])==null?void 0:t.modal)},handleJob(t){n.sleep(this.sleepDelay).then(()=>{var s;const e=t.objects?t.objects[0]:t;if(e){const i=(s=window.i18n)==null?void 0:s.translate("gender"),{title:r,description:a}=e,o={description:a,title:r,gender:i};this.hideLoading=!0,this.update(o)}else console.error("handleJob has no entry")})},stopLoading(){setTimeout(()=>{this.loading.off(!0,!0),this.hasLoading=!1},this.loadingDelay)},update(t){this.entryData=t,this.stopLoading()},loadLocalJobData(){const t=`${this.api.jobDataUrl}${this.jobIdValue}.json`;return this.addCustomStyle(),fetch(t,{method:"GET",headers:{"Content-Type":"application/json"}}).then(e=>e.json()).then(e=>{if(e.videoInner)return this.videoInner=e.videoInner;this.personQuote=e.personQuote}).catch(e=>{console.error("Job-list-Detail Local Job Data Error:",e)})},addCustomStyle(){var e;const t=document.createElement("style");t.id=this.getUuid,(e=document.getElementById(this.getUuid))==null||e.remove(),t.innerHTML=`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),ls=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"job-list",computed:{classList(){return["job-list container",`${this.hasLoading?l.LOADING:""}`,`${this.hasLoader?"loading":""}`,`${n.isTrue(this.sticky)===!0?U.rootSelector.substring(1):""}`,"vue-component"]},expandClassList(){return["job-list__expand-button",`${this.hasExpand?"":l.HIDDEN}`,`${this.isExpandVisible?"":l.INVISIBLE}`]},headlineClassValue(){return`job-list__headline ${this.headlineClasses}`},headlineLevelValue(){return`${this.headlineLevel?this.headlineLevel:"h2"}`},tagList(){return this.tags?this.tags.split(","):void 0}},mounted(){this.api=new te({...this.jobId&&{jobId:this.jobId},...this.apiUrl&&{apiUrl:this.apiUrl},client_name:this.clientName}),this.lang&&this.api.setLang(this.lang),this.tagList&&this.api.setFilter({tags:this.tagList}),this.loading=new pe(this.$refs["job-list"],()=>{this.hasLoader=!0}),this.loading.on(!0),this.init()},methods:{init(){var s;const t=(s=window.i18n)==null?void 0:s.loader,e=this.jobId?this.loadJob:this.loadJobs;t?t.then(()=>{var i;this.translationData=(i=window.i18n)==null?void 0:i.getTranslationData(["jobListEmpty"]),e.bind(this)()}):e()},handleExpand(){this.isExpandVisible=!1,this.hasExpand=!1,this.showJobs()},showJobs(){this.entries.forEach(t=>{t.isInvisible=!1})},loadJobData(){const t=`${this.api.jobDataUrl}jobs.json`;return fetch(t,{method:"GET",headers:{"Content-Type":"application/json"}}).then(e=>e.json()).then(e=>{this.jobData=e}).catch(e=>{console.error("Job-list Local Job Data Error:",e)})},loadJob(t){const e=t?"getAll":"getOpening";this.promises.push(this.loadJobData()),this.api[e]().then(s=>s.json()).then(s=>{this.handleJobs(s)}).catch(s=>{console.error("Job-list Error:",s)})},loadJobs(){this.loadJob(!0)},handleJobs(t){n.sleep(this.sleepDelay).then(()=>{let e=t;if(typeof e.objects!="object"&&(e={objects:[e],meta:e==null?void 0:e.meta}),this.data=e,!this.data.meta)return this.loading.off();Promise.all(this.promises).then(()=>{const s=this.api.getOrderedList(e.objects);this.filterJobs(t,s)}).catch(s=>{console.error("Job-List Promises.all ~ error",s)})})},filterJobs(t,e){var a,o,c;this.data.objects=e;const s=(a=window.i18n)==null?void 0:a.translate("gender"),i=[];let r=0;for(let d=0;d<(e==null?void 0:e.length);d++){const h=e[d],{city:u}=(h==null?void 0:h.location)||{};if(!h)continue;const{title:y,position_type:M,team:q}=h,hi={city:u,title:y,gender:s,team:q,positionType:M!==""?(o=window.i18n)==null?void 0:o.translate(M):null,isInvisible:this.maxItems>0&&r>this.maxItems-1,id:d};this.isAvailableEntry(h)&&(i[d]=hi,r++)}this.entries=i,this.entries.length===0&&(this.isEmpty=!0),this.maxItems>0&&((c=t.objects)==null?void 0:c.length)>this.maxItems&&this.showExpandButton(),this.stopLoading()},showExpandButton(){this.hasExpand=!0,setTimeout(()=>{this.isExpandVisible=!0},this.loadingDelay)},isAvailableEntry(t){var s;let e=!0;if(t.tags.includes(this.api.hiddenTag))return!1;if(this.team){const i=(s=t.team)==null?void 0:s.toLowerCase(),r=this.team.toLowerCase();(i===void 0||(i==null?void 0:i.indexOf(r))===-1)&&(e=!1)}return e},stopLoading(){setTimeout(()=>{this.loading.off(!0,!0),this.hasLoading=!1},this.loadingDelay)},handleEntryClick(t){const e=t.currentTarget;if(e&&this.detailUrl){const s=this.getData(e),i=this.getDetailUrl(s),r=n.generateUrl(s==null?void 0:s.title,i,s==null?void 0:s.id);document.location.href=r}},getData(t){var s;let e=null;return t&&t.dataset.id&&((s=this.data)!=null&&s.objects)&&(e=this.data.objects[t.dataset.id]),e},getDetailUrl(t){if(typeof this.detailUrl!="object")return this.detailUrl;const e=this.api.getLangFromEntry(t);return this.detailUrl[e]||this.detailUrl.default}},data(){return{loadingDelay:300,sleepDelay:1300,loading:{},hasLoading:!0,hasLoader:!1,api:{},hasExpand:!1,isExpandVisible:!1,entries:[],jobData:{},promises:[],isEmpty:!1}},props:{clientName:String,maxItems:String,detailUrl:Object,jobId:String,tags:String,lang:String,team:String,apiUrl:String,headlineClasses:String,headlineLevel:String,headlineText:String,expandText:String,sublineText:String,sticky:{default:null}},template:`
    <div
      :class="classList"
      :data-id="clientName"
  ...
  `}},Symbol.toStringTag,{value:"Module"})),ds=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"link-list",computed:{classList(){return["link-list",this.hasNoAnimation?"":"utility-animation",`${this.isExpanded?l.EXPANDED:""}`,`${this.isExpandable()?l.EXPANDABLE:""}`,`${this.hasActiveItem?l.ACTIVE:""}`,`${this.isHidden?"link-list--hidden":""}`,`${this.inTransition?"link-list--in-transition":""}`,this.classes,"vue-component"]},hasNoAnimation(){return n.isTrue(this.noAnimation)},classListTitle(){return["link-list__title font-size-8 bold",this.hasNoAnimation?"":"fade-in-bottom"]},classListList(){return["link-list__list header__list--expanded",this.hasNoAnimation?"":"fade-in-bottom"]},hasActiveItem(){const t=this.list.children;if(t)return t.filter(e=>{var s;return((s=e.languages[this.lang])==null?void 0:s.active)===!0}).length>0},isHidden(){return n.isTrue(this.hidden)===!0}},watch:{hidden(t,e){t||(this.inTransition=!0)}},updated(){this.updateHeight(),this.inTransition=!1},mounted(){this.bindEvents()},methods:{bindEvents(){this.parentOfParent=this.$refs.root.parentNode.parentNode,this.parentOfParent.addEventListener(f.CHILD_HAS_UPDATE,this.handleUpdate.bind(this))},handleUpdate(t){const e=t.detail.root;this.isExpanded&&this.$refs.root!==e&&this.handleClick()},isLowerBreakpoint(){return n.isBelowBreakpoint("md")},isExpandable(){var t;return!!(this.isLowerBreakpoint()&&this.list.languages&&((t=this.list.languages[this.lang])!=null&&t.title))},updateHeight(){const t=this.$refs.root;if(!t)return;const e=this.isHidden?"":t.scrollHeight+"px";t.style.height=e},handleClick(t){if(!this.isExpandable())return;this.isExpanded=!this.isExpanded;const e=this.$refs.root;if(t){const s=new CustomEvent(f.CHILD_HAS_UPDATE,{detail:{root:e}});this.parentOfParent.dispatchEvent(s)}!e||this.isExpanded||(e.style.height="")}},props:{list:Object,lang:String,classes:String,hidden:{default:null},noAnimation:{default:null}},data(){return{inTransition:!1,isExpanded:!1,parentOfParent:null}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),ps=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"logo-list",components:{"logo-list-items":{tagName:"logo-list-items",computed:{},methods:{getItemComponent(t){return t!=null&&t.url?"a":"span"},getDelay(t){const e=this.getIndex(t),s=e>0?100:0;return`--utility-animation-delay: ${`${e*s}ms`};`},getIndex(t){return this.isClone?this.list.length+t:t}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),us=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"lottie",computed:{classList(){return["lottie","vue-component"]},jsonData(){return n.getJSON(this.data)},widthValue(){return this.width&&this.width!==""?this.width:"100%"},heightValue(){return this.height&&this.height!==""?this.height:"100%"},backgroundValue(){return this.background&&this.background!==""?this.background:"transparent"},loopValue(){return this.loop&&this.loop!==""?this.loop:!0},autoplayValue(){return this.autoplay&&this.autoplay!==""?this.autoplay:!0},nameValue(){return this.name&&this.name!==""?this.name:"lottie-"+Math.random()},rendererValue(){return this.renderer&&this.renderer!==""?this.renderer:"svg"},pathValue(){return this.path&&this.path!==""?this.path:null},options(){return{container:this.$refs.animContainer,name:this.nameValue,renderer:this.rendererValue,loop:this.loopValue,autoplay:this.autoplayValue,width:this.getSize(this.widthValue),height:this.getSize(this.heightValue),path:this.pathValue,animationData:this.jsonData}}},data(){return{style:{}}},mounted(){this.initStyle(),this.loadAnimation()},methods:{initStyle(){this.style={width:this.getSize(this.widthValue),height:this.getSize(this.heightValue),background:this.backgroundValue}},getSize(t){return!t.indexOf||t.indexOf("px")===-1&&t.indexOf("%")===-1?`${t}px`:t},loadAnimation(){let t=lottie.then(e=>{e.loadAnimation(this.options),this.$emit("animControl",t)})}},props:{data:Object,name:{type:String},width:{type:[String,Number]},height:{type:[String,Number]},background:{type:String},loop:{type:[Boolean,Number]},autoplay:{type:Boolean},renderer:{type:String},path:{type:String}},template:`
    <div :class="classList">
      <div class="lottie__container" :style="style" ref="animContainer"></div>
    </div>
  `}},Symbol.toStringTag,{value:"Module"})),ms=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"modal",computed:{modalErrorValue(){return n.getJSON(this.modalError)},classList(){return["modal fade",this.slimValue?"modal--slim":"",this.notificationValue?"modal--notification":"",this.isCenterSlim?"modal--center-slim":"","vue-component"]},dialogClassList(){return["modal-dialog",`${this.slimValue?"modal-lg":"modal-xl"}`,`${this.centerValue?"modal-dialog-centered":""}`]},settings(){return{"data-client-name":this.clientName?this.clientName:null,"data-api-url":this.apiUrl?this.apiUrl:null,"data-job-id":this.jobId?this.jobId:null,"data-modal-id":this.modalId?this.modalId:null,"data-api-key":this.apiKey?this.apiKey:null,"data-mock-apply-url":this.mockApplyUrl?this.mockApplyUrl:null,"data-mock-documents-url":this.mockDocumentsUrl?this.mockDocumentsUrl:null}},isCenterSlim(){return this.slimValue&&this.centerValue},modal(){return this.$refs.modal},centerValue(){return n.isTrue(this.center)},slimValue(){return n.isTrue(this.slim)},loadingValue(){return this.loading?!0:null},notificationValue(){return n.isTrue(this.notification)},size(){return this.slimValue||this.notificationValue?"small":null},hasCircleAndHover(){return!(this.isCenterSlim||this.notificationValue)},circle(){return this.hasCircleAndHover},hover(){return this.hasCircleAndHover},bodyClasses(){return["modal__body",this.loading?l.LOADING:null]}},mounted(){this.bindEvents(),this.show===!0&&this.openModal()},unmounted(){this.observer.disconnect(),document.removeEventListener(f.LOAD_MODAL,this.handleLoading)},methods:{isModalOpen(){return!!document.body.classList.contains("modal-open")},setModalMode(t){const e=document.querySelector("html");t?e.classList.add(l.MODAL_OPEN):(e.classList.remove(l.MODAL_OPEN),this.handleClose())},handleClose(){const e=this.$refs.modal.querySelector(B.rootSelector);if(!e)return;const s=B.getInstance(e);s||B.reset(s.form)},bindEvents(){this.observer=new MutationObserver(this.handleMutation),setTimeout(()=>{this.observer.observe(document.body,{attributes:!0})},200),document.addEventListener(f.LOAD_MODAL,this.handleLoading)},handleMutation(){this.setModalMode(this.isModalOpen())},handleLoading(t){const e=t==null?void 0:t.detail;this.loading=e},openModal(){setTimeout(()=>{R.open(this.$refs.modal)},70)}},data(){return{observer:null,loading:!1,blabla:"text"}},props:{clientName:String,apiUrl:String,jobId:String,modalId:String,slim:{default:null},show:{default:null},center:{default:null},notification:{default:null},apiKey:String,mockApplyUrl:String,mockDocumentsUrl:String,modalError:Object},template:`
    ...
    </div>`}},Symbol.toStringTag,{value:"Module"})),gs=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"person-quote",props:{img:String,text:String,name:String,srcSet:Object},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),fs=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"post-teaser",data(){return{translationData:null,spacing:2}},computed:{formattedDate(){var e;const t=(e=this.postData)==null?void 0:e.date;if(t)return t.split("-").reverse().join(".")},classList(){return["post-teaser",this.classes!==""?this.classes:"","vue-component"]},title(){var t,e,s,i;return((t=this.postData)==null?void 0:t.lang)!==this.lang&&this.postData.lang!==""&&((e=this.translationData)!=null&&e.onlyLanguage)?`${this.postData.title} (${(s=this.translationData)==null?void 0:s.onlyLanguage})`:(i=this.postData)==null?void 0:i.title},excerpt(){var e;return n.decodeHTML(n.truncateWords((e=this.postData)==null?void 0:e.excerpt,30))},imgUrl(){var t;return`/blog/heads/${(t=this.postData)==null?void 0:t.blogtitlepic}.jpg`},postData(){return n.getJSON(this.post)},listClasses(){return`list-inline-item mx-sm-n${this.spacing}`},href(){var t;return(t=this.postData)==null?void 0:t.url}},beforeMount(){var e;const t=(e=window.i18n)==null?void 0:e.loader;t&&t.then(()=>{var s;this.translationData=(s=window.i18n)==null?void 0:s.getTranslationData(["onlyLanguage"])})},props:{classes:String,post:Object,tag:String,site:Object,lang:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),ue={},ys=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"search",computed:{classList(){return["search",`${this.searchExpanded?"search--expanded":""}`,"vue-component"]},limitedResults(){var t;return(t=this.results)==null?void 0:t.slice(0,this.maxResults)}},data(){return{search:null,store:null,results:null,maxResults:15,searchExpanded:!1}},methods:{handleEnter(){const t=`${this.endpoint}`;if(t)return this.store?this.handleSearch():fetch(t,{method:"GET",headers:{"Content-Type":"application/json"}}).then(e=>e.json()).then(e=>{this.store=e,this.handleSearch()}).catch(e=>{console.log("handleEnter ~ error",e)})},handleSearch(){this.searchEngine||this.initSearchEngine();const t=`${this.$refs.search.value}`;t&&(this.results=this.searchEngine.search(t),console.log("handleSearch ~ this.results",this.results))},initSearchEngine(){const t=this.store,{results:e,weights:s}=t;if(!ue)return;const i={includeScore:!0,ignoreLocation:!0,findAllMatches:!0,includeMatches:!0,threshold:.2,keys:s};this.searchEngine=new ue(e,i)},handleSearchBar(){this.searchExpanded=!this.searchExpanded,window.addEventListener("click",this.handleOutsideClick.bind(this))},handleOutsideClick(t){this.searchExpanded=n.isOutsideOf("search",t)?!1:this.searchExpanded}},props:{placeholder:String,endpoint:String,language:String},template:`
    <div :class="classList">
      <icon
  ...
  `}},Symbol.toStringTag,{value:"Module"})),_s=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"services",computed:{classValue(){return["services",this.author?`services--author ${this.authorHasSocials?"":"services--no-socials"}`:"","vue-component"]},authorHasSocials(){var t;return((t=this.author)==null?void 0:t.socials)!==void 0},itemsList(){return this.authorHasSocials?this.author.socials:this.items}},methods:{},props:{items:{default:null},title:{default:null},label:{default:null},value:{default:null},author:{default:null},shareUrl:{default:null}},template:`
...
`}},Symbol.toStringTag,{value:"Module"})),Ss=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"shape-animation",computed:{tag(){return this.isAnimate?"animate":this.isMotion?"animateMotion":"animateTransform"},isAnimate(){let t=!1;switch(this.attributeName){case"opacity":t=!0;break}return t},defaultCalcMode(){return this.isAnimate?null:"spline"},defaultKeyTimes(){return this.isAnimate?null:"0;1"},effectiveKeySplines(){return this.isAnimate?null:this.keySplines}},props:{id:String,href:String,begin:String,attributeName:String,by:String,from:String,to:String,dur:String,fill:String,calcMode:String,keyTimes:String,keySplines:String,keyPoints:String,type:String,additive:Boolean,isMotion:Boolean,isAnimate:Boolean,path:String,values:String},template:`
    ...
    />
  `}},Symbol.toStringTag,{value:"Module"}));class D{constructor({tagName:e,elements:s,begin:i}){this.tagName=e,this.elements=s,this.begin=i,this.tagNameId=this.createTagNameId()}createStepNames(e){return this.elements.forEach(s=>{const i=s.name;e[i]=s,Object.keys(s).forEach(a=>{if(a==="name")return;const o=s[a];o&&(o.id=this.getStepId(`${i.toLowerCase()}-${a}`))})}),e}getSequence(){const e=this.createStepNames({});return this.elements.forEach(s=>{const i=s.name;e[i]=s,Object.keys(s).forEach(a=>{if(a==="name")return;const o=s[a];o&&(o.begin=this.getStepBegin(e,o),o.start&&(o.begin=`${this.begin};${o.begin}`))}),s.id=this.getStepId(`${i.toLowerCase()}-id`),s.href=`#${s.id}`}),e}getStepBegin(e,s){const a=`${(""+s.delay).indexOf("s")!==-1?s.delay:`${s.delay}s`}`;return s.waitFor?`${this.getWaitForName(e,s.waitFor)}+${a}`:a}getWaitForName(e,s){const i=".end",r=s.split("."),a=r[0],o=r[1];return`${e[a]&&e[a][o]?e[a][o].id:""}${i}`}getStepId(e){return`${this.tagNameId}__${e}`}createTagNameId(){return`${n.uuid()}-${this.tagName}`}}const Cs="0.1s",oe="7s",T="0.05s",me="shape-circle-within-square",ks=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:me,computed:{begin(){return this.start?this.start:Cs},firstSquareStaticColor(){return this.firstColor?this.firstColor:"var(--color-orange)"},firstCircleColor(){return this.secondColor?this.secondColor:"var(--color-white)"},secondSquareColor(){return this.secondColor?this.secondColor:"var(--color-white)"},secondCircleColor(){return this.thirdColor?this.thirdColor:"var(--color-gigas)"},thirdSquareColor(){return this.thirdColor?this.thirdColor:"var(--color-gigas)"},thirdCircleColor(){return this.firstColor?this.firstColor:"var(--color-orange)"},firstCircle(){return this.sequence.firstCircle},secondSquare(){return this.sequence.secondSquare},secondCircle(){return this.sequence.secondCircle},thirdSquare(){return this.sequence.thirdSquare},thirdCircle(){return this.sequence.thirdCircle},fourthSquare(){return this.sequence.fourthSquare},overall(){return{keySplines:"0 0 1 1",dur:"1.8s"}},width(){return 400},height(){return this.width},clipPathId(){var t;return`${(t=this.shapeElements)==null?void 0:t.getStepId("clip-path")}`},clipPathUrl(){return`clip-path: url(#${this.clipPathId});`},sequence(){var t;return(t=this.shapeElements)==null?void 0:t.getSequence()},shapeElements(){return this.shapeElementsInstance||(this.shapeElementsInstance=new D({tagName:me,elements:this.elements,begin:this.begin})),this.shapeElementsInstance}},data(){return{animations:[{steps:[{name:"transform2",from:"400 0",to:"0 0",dur:"0.3s",type:"translate"}]},{steps:[{name:"transform",dur:"",from:"0 0",to:"1 1",type:"scale"}]}],elements:[{name:"firstCircle",transform:{delay:T,values:"0 0;1 1;1 -1",keyTimes:"0;0.5;1",keySplines:"0.333 0 0.667 1;0.333 0 0.667 1",start:!0,waitFor:"fourthSquare.transform2"},reset:{waitFor:"secondSquare.transform2",delay:T,dur:"0.01s"}},{name:"secondSquare",transform2:{delay:oe,waitFor:"firstCircle.transform"},reset:{waitFor:"thirdSquare.transform2",delay:T,dur:"0.01s"}},{name:"secondCircle",transform:{delay:T,values:"0 0;1 1;1 -1",keyTimes:"0;0.5;1",keySplines:"0.333 0 0.667 1;0.333 0 0.667 1",waitFor:"secondSquare.transform2"},reset:{waitFor:"thirdSquare.transform2",delay:T,dur:"0.01s"}},{name:"thirdSquare",transform2:{delay:oe,waitFor:"secondCircle.transform"},reset:{waitFor:"fourthSquare.transform2",delay:T,dur:"0.01s"}},{name:"thirdCircle",transform:{delay:T,values:"0 0;1 1;1 -1",keyTimes:"0;0.5;1",keySplines:"0.333 0 0.667 1;0.333 0 0.667 1",waitFor:"thirdSquare.transform2"},reset:{waitFor:"fourthSquare.transform2",delay:T,dur:"0.01s"}},{name:"fourthSquare",transform2:{delay:oe,waitFor:"thirdCircle.transform"},reset:{waitFor:"fourthSquare.transform2",delay:T,dur:"0.01s"}}],shapeElementsInstance:null}},props:{firstColor:String,secondColor:String,thirdColor:String,start:String},methods:{getStepData(t,e){const s=this.sequence[t];if(!s)return;const i=[];return e.forEach(r=>{const a={...r},o=s[a==null?void 0:a.name];if(!o)return;o.href=s.href,o.by&&(a.by=o.by),o.from&&(a.from=o.from),o.to&&(a.to=o.to),o.additive&&(a.additive=o.additive),o.dur&&(a.dur=o.dur),o.motion&&(a.motion=o.motion),o.keyTimes&&(a.keyTimes=o.keyTimes),a.dur||(a.dur=this.overall.dur),a.keySplines||(a.keySplines=o.keySplines?o.keySplines:this.overall.keySplines);const c={step:a,data:o};i.push(c)}),i}},template:`
    <g :class="classList">
      ...
      </g>`}},Symbol.toStringTag,{value:"Module"})),ws="1s",_="7",S="0.05",ge="shape-fast-forward",Ds=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:ge,computed:{classList(){return["shape-square-forward","vue-component"]},begin(){return this.start?this.start:ws},rectColor(){return this.backgroundColor?this.backgroundColor:"var(--color-primary-accent)"},pathColor(){return this.firstColor?this.firstColor:"var(--color-primary-accent-light)"},secondArrowColor(){return this.secondColor?this.secondColor:"var(--color-secondary)"},firstArrow(){return this.sequence.firstArrow},secondArrow(){return this.sequence.secondArrow},thirdArrow(){return this.sequence.thirdArrow},overall(){return{keySplines:"0.19 1 0.2 1",dur:"1.3s"}},internalWidth(){return this.width?this.width:400},internalHeight(){return this.internalWidth},halfWidth(){return this.internalWidth/2},halfHeight(){return this.internalHeight/2},clipPathId(){var t;return`${(t=this.shapeElements)==null?void 0:t.getStepId("clip-path")}`},clipPathUrl(){return`clip-path: url(#${this.clipPathId});`},sequence(){var t;return(t=this.shapeElements)==null?void 0:t.getSequence()},shapeElements(){return this.shapeElementsInstance||(this.shapeElementsInstance=new D({tagName:ge,elements:this.elements,begin:this.begin})),this.shapeElementsInstance},points(){const t=this.internalWidth,e=this.halfWidth,s=this.internalHeight,i=this.halfHeight;return{firstArrow:`0,0 0,${s} ${i},${e}`,secondArrow:`${e},0, ${e},${s}, ${t},${i}`,thirdArrow:`${-e},0, ${-e},${s}, 0,${e}`}}},data(){return{animations:[{steps:[{name:"moveTo1",from:"0",to:"-400",dur:"0.01s",type:"translate"}]},{steps:[{name:"show",from:"0.1",to:"1",dur:"0.01s",attributeName:"opacity",animate:!0}]},{steps:[{name:"moveTo2",to:"-200",from:"-400",type:"translate"}]},{steps:[{name:"moveTo3",by:"200",type:"translate"}]},{steps:[{name:"hide",from:"0.6",to:"0.1",dur:"0.01s",attributeName:"opacity",animate:!0}]},{steps:[{name:"moveTo4",type:"translate"},{name:"shrink",type:"scale",additive:!0,from:"1 1",to:"0.1 0.1"}]}],elements:[{name:"firstArrow",moveTo3:{start:!0,waitFor:"firstArrow.reset",delay:_},shrink:{waitFor:"firstArrow.moveTo3",delay:_},moveTo4:{waitFor:"firstArrow.moveTo3",from:"200",to:"400",delay:_},hide:{waitFor:"firstArrow.moveTo4",delay:S},moveTo1:{waitFor:"firstArrow.hide",delay:S,from:"-400",to:"-200"},show:{waitFor:"firstArrow.moveTo1",delay:S},reset:{waitFor:"firstArrow.show",delay:_-S*3.5}},{name:"secondArrow",moveTo4:{start:!0,waitFor:"secondArrow.reset",delay:_,from:"0",to:"200"},shrink:{start:!0,waitFor:"secondArrow.reset",delay:_},hide:{waitFor:"secondArrow.shrink",delay:S},moveTo1:{waitFor:"secondArrow.hide",delay:S,dur:"0.001s"},show:{waitFor:"secondArrow.moveTo1",delay:S},moveTo2:{waitFor:"secondArrow.show",delay:_-S*3.5},reset:{waitFor:"secondArrow.moveTo2",delay:_}},{name:"thirdArrow",moveTo2:{start:!0,waitFor:"thirdArrow.show",delay:_-S*3.5,from:"0",to:"200"},moveTo3:{waitFor:"thirdArrow.moveTo2",delay:_,from:"200",to:"400"},shrink:{waitFor:"thirdArrow.moveTo3",delay:_},moveTo4:{waitFor:"thirdArrow.moveTo3",from:"400",to:"600",delay:_},hide:{waitFor:"thirdArrow.moveTo4",delay:S},reset:{waitFor:"thirdArrow.hide",delay:S,dur:"0.01s"},show:{waitFor:"thirdArrow.reset",delay:S}}],shapeElementsInstance:null}},props:{backgroundColor:String,firstColor:String,secondColor:String,start:String,width:String},methods:{getStepData(t,e){const s=this.sequence[t];if(!s)return;const i=[];return e.forEach(r=>{const a={...r},o=s[a==null?void 0:a.name];if(!o)return;o.href=s.href,o.by&&(a.by=o.by),o.from&&(a.from=o.from),o.to&&(a.to=o.to),o.additive&&(a.additive=o.additive),o.dur&&(a.dur=o.dur),o.animate&&(a.animate=o.animate),a.dur||(a.dur=this.overall.dur),a.keySplines||(a.keySplines=this.overall.keySplines);const c={step:a,data:o};i.push(c)}),i}},template:`
    <g :class="classList">
      <clipPath :id="clipPathId">
    ...
    </g>`}},Symbol.toStringTag,{value:"Module"})),xs="0s",W="6s",C="0.3s",fe="shape-four-squares",Ls=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:fe,computed:{begin(){return this.start?this.start:xs},squareUpperLeftFirstColor(){return this.firstColor?this.firstColor:"var(--color-blue-light)"},squareUpperRightFirstColor(){return this.secondColor?this.secondColor:"var(--color-white)"},squareBottomLeftFirstColor(){return this.secondColor?this.secondColor:"var(--color-white)"},squareBottomRightFirstColor(){return this.firstColor?this.firstColor:"var(--color-blue-light)"},squareUpperLeftSecondColor(){return this.thirdColor?this.thirdColor:"var(--color-orange)"},squareUpperRightSecondColor(){return this.fourthColor?this.fourthColor:"var(--color-gigas)"},squareBottomLeftSecondColor(){return this.fourthColor?this.fourthColor:"var(--color-gigas)"},squareBottomRightSecondColor(){return this.thirdColor?this.thirdColor:"var(--color-orange)"},squareUpperLeftFirst(){return this.sequence.squareUpperLeftFirst},squareUpperRightFirst(){return this.sequence.squareUpperRightFirst},squareBottomLeftFirst(){return this.sequence.squareBottomLeftFirst},squareBottomRightFirst(){return this.sequence.squareBottomRightFirst},squareUpperLeftSecond(){return this.sequence.squareUpperLeftSecond},squareUpperRightSecond(){return this.sequence.squareUpperRightSecond},squareBottomLeftSecond(){return this.sequence.squareBottomLeftSecond},squareBottomRightSecond(){return this.sequence.squareBottomRightSecond},squareUpperLeftReset(){return this.sequence.squareUpperLeftReset},squareUpperRightReset(){return this.sequence.squareUpperRightReset},squareBottomLeftReset(){return this.sequence.squareBottomLeftReset},squareBottomRightReset(){return this.sequence.squareBottomRightReset},overall(){return{keySplines:"0 0 1 1",dur:"0.8s"}},width(){return 400},height(){return this.width},clipPathId(){var t;return`${(t=this.shapeElements)==null?void 0:t.getStepId("clip-path")}`},clipPathUrl(){return`clip-path: url(#${this.clipPathId});`},sequence(){var t;return(t=this.shapeElements)==null?void 0:t.getSequence()},shapeElements(){return this.shapeElementsInstance||(this.shapeElementsInstance=new D({tagName:fe,elements:this.elements,begin:this.begin})),this.shapeElementsInstance}},data(){return{animations:[{steps:[{name:"moveTo1",from:"0 -200",to:"0 0",dur:"",type:"translate"}]},{steps:[{name:"moveTo2",from:"400 0",to:"200 0",dur:"",type:"translate"}]},{steps:[{name:"moveTo3",from:"-200 200",to:"0 200",dur:"",type:"translate"}]},{steps:[{name:"moveTo4",from:"200 400",to:"200 200",dur:"",type:"translate"}]}],elements:[{name:"squareUpperLeftFirst",moveTo1:{start:!0,delay:C,waitFor:"squareUpperLeftSecond.reset"},reset:{waitFor:"squareUpperLeftSecond.moveTo1",delay:C,dur:"0.01s"}},{name:"squareUpperRightFirst",moveTo2:{start:!0,delay:C,waitFor:"squareUpperLeftSecond.reset"},reset:{waitFor:"squareUpperRightSecond.moveTo2",delay:C,dur:"0.01s"}},{name:"squareBottomLeftFirst",moveTo3:{start:!0,delay:C,waitFor:"squareUpperLeftSecond.reset"},reset:{waitFor:"squareBottomLeftSecond.moveTo3",delay:C,dur:"0.01s"}},{name:"squareBottomRightFirst",moveTo4:{start:!0,delay:C,waitFor:"squareUpperLeftSecond.reset"},reset:{waitFor:"squareBottomRightSecond.moveTo4",delay:C,dur:"0.01s"}},{name:"squareUpperLeftSecond",moveTo1:{delay:C,waitFor:"squareUpperLeftFirst.moveTo1"},reset:{waitFor:"squareUpperLeftSecond.moveTo1",delay:W,dur:"1s"}},{name:"squareUpperRightSecond",moveTo2:{delay:C,waitFor:"squareUpperRightFirst.moveTo2"},reset:{waitFor:"squareUpperRightSecond.moveTo2",delay:W,dur:"1s"}},{name:"squareBottomLeftSecond",moveTo3:{delay:C,waitFor:"squareBottomLeftFirst.moveTo3"},reset:{waitFor:"squareBottomLeftSecond.moveTo3",delay:W,dur:"1s"}},{name:"squareBottomRightSecond",moveTo4:{delay:C,waitFor:"squareBottomRightFirst.moveTo4"},reset:{waitFor:"squareBottomRightSecond.moveTo4",delay:W,dur:"1s"}}],shapeElementsInstance:null}},props:{firstColor:String,secondColor:String,thirdColor:String,fourthColor:String,start:String},methods:{getStepData(t,e){const s=this.sequence[t];if(!s)return;const i=[];return e.forEach(r=>{const a={...r},o=s[a==null?void 0:a.name];if(!o)return;o.href=s.href,o.by&&(a.by=o.by),o.from&&(a.from=o.from),o.to&&(a.to=o.to),o.additive&&(a.additive=o.additive),o.dur&&(a.dur=o.dur),o.motion&&(a.motion=o.motion),o.keyTimes&&(a.keyTimes=o.keyTimes),a.dur||(a.dur=this.overall.dur),a.keySplines||(a.keySplines=o.keySplines?o.keySplines:this.overall.keySplines);const c={step:a,data:o};i.push(c)}),i}},template:`
    <g :class="classList">
      <clipPath :id="clipPathId">
        <rect x="0" y="0" :width="width" :height="height" />
      </clipPath>
    ...
    </g>`}},Symbol.toStringTag,{value:"Module"})),Ts="0s",x="1s",J="0.01s",Z="0.01s",ve="shape-four-triangles",Ms=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:ve,computed:{begin(){return this.start?this.start:Ts},triangleBottomLeftColor(){return this.firstColor?this.firstColor:"var(--color-orange)"},triangleUpperLeftColor(){return this.secondColor?this.secondColor:"var(--color-secondary)"},triangleUpperRightColor(){return this.firstColor?this.firstColor:"var(--color-orange)"},triangleBottomRightColor(){return this.secondColor?this.secondColor:"var(--color-secondary)"},squareColor(){return this.thirdColor?this.thirdColor:"var(--color-white)"},triangleBottomLeft(){return this.sequence.triangleBottomLeft},triangleUpperLeft(){return this.sequence.triangleUpperLeft},triangleUpperRight(){return this.sequence.triangleUpperRight},triangleBottomRight(){return this.sequence.triangleBottomRight},square(){return this.sequence.square},overall(){return{keySplines:"0 0 1 1",dur:"4s"}},width(){return 400},height(){return this.width},clipPathId(){var t;return`${(t=this.shapeElements)==null?void 0:t.getStepId("clip-path")}`},clipPathUrl(){return`clip-path: url(#${this.clipPathId});`},sequence(){var t;return(t=this.shapeElements)==null?void 0:t.getSequence()},shapeElements(){return this.shapeElementsInstance||(this.shapeElementsInstance=new D({tagName:ve,elements:this.elements,begin:this.begin})),this.shapeElementsInstance}},data(){return{animations:[{steps:[{name:"motion",attributeName:"motion",motion:!0,dur:""}]},{steps:[{name:"transformRotate",dur:"",type:"rotate"}]},{steps:[{name:"moveTo1",dur:"",type:"translate",additive:!0}]}],elements:[{name:"triangleBottomLeft",moveTo1:{start:!0,delay:x,from:"-200 0",to:"-200 0",keyTimes:"0;1",keySplines:"0 0 1 1",values:"-200 0;-200 0",waitFor:"triangleBottomLeft.reset"},motion:{start:!0,delay:x,path:"M200 400 C200,400 200,200 200,200 C200,200 200,200 200,200",keyPoints:"0;1;1",keyTimes:"0;0.333333;1",keySplines:"0.333 0 0.667 1;0 0 0 0",waitFor:"triangleBottomLeft.reset"},transformRotate:{start:!0,delay:x,from:"90",to:"0",values:"90;90;0;0",keyTimes:"0;0.333333;0.666667;1",keySplines:"0.333 0 0.667 1;0.333 0 0.667 1;0 0 0 0",waitFor:"triangleBottomLeft.reset"},reset:{waitFor:"square.moveTo1",delay:J,dur:Z}},{name:"triangleUpperLeft",moveTo1:{start:!0,delay:x,from:"-200 0",to:"-200 0",keyTimes:"0;1",keySplines:"0 0 1 1",values:"-200 0;-200 0",waitFor:"triangleUpperLeft.reset"},motion:{start:!0,delay:x,keyTimes:"0;0.666667;0.95;1",path:"M200 200 C200,200 200,200 200,200 C200,200 400,200 400,200 C400,200 400,200 400,200",keySplines:"0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0 0 0 0",keyPoints:"0;0;1;1",waitFor:"triangleUpperLeft.reset"},transformRotate:{start:!0,delay:x,from:"90",to:"0",values:"90;90;0;0",keyTimes:"0;0.333333;0.666667;1",keySplines:"0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0 0 0 0",waitFor:"triangleUpperLeft.reset"},reset:{waitFor:"square.moveTo1",delay:J,dur:Z}},{name:"triangleUpperRight",moveTo1:{start:!0,delay:x,from:"-100 -100",to:"-100 -100",keyTimes:"0;1",keySplines:"0 0 1 1",values:"-100 -100;-100 -100",waitFor:"triangleUpperRight.reset"},motion:{start:!0,delay:x,keyTimes:"0;0.522222;0.855556;1",keySplines:"0.333 0 0.667 1;0.333 0 0.667 1;0 0 0 0",path:"M300 100 C300,100 300,100 300,100 C300,100 100,100 100,100 C100,100 100,100 100,100",keyPoints:"0;0;1;1",waitFor:"triangleUpperRight.reset"},reset:{waitFor:"square.moveTo1",delay:J,dur:Z}},{name:"triangleBottomRight",moveTo1:{start:!0,delay:x,from:"-100 -100",to:"-100 -100",keyTimes:"0;1",keySplines:"0 0 1 1",values:"-100 -100;-100 -100",waitFor:"triangleBottomRight.reset"},motion:{start:!0,delay:x,keyTimes:"0;0.333333;1",keySplines:"0.167 0.167 0.833 0.833;0 0 0 0",path:"M300 300 C300,300 300,100 300,100 C300,100 300,100 300,100",keyPoints:"0;1;1",waitFor:"triangleBottomRight.reset"},reset:{waitFor:"square.moveTo1",delay:J,dur:Z}},{name:"square",moveTo1:{delay:"14s",dur:"0.5s",from:"0 0",to:"-400 0",waitFor:"triangleBottomRight.moveTo1"},reset:{waitFor:"square.moveTo1",delay:"1s",dur:"0.5s"}}],shapeElementsInstance:null}},props:{firstColor:String,secondColor:String,thirdColor:String,start:String},methods:{getStepData(t,e){const s=this.sequence[t];if(!s)return;const i=[];return e.forEach(r=>{const a={...r},o=s[a==null?void 0:a.name];if(!o)return;o.href=s.href,o.by&&(a.by=o.by),o.from&&(a.from=o.from),o.to&&(a.to=o.to),o.additive&&(a.additive=o.additive),o.dur&&(a.dur=o.dur),o.motion&&(a.motion=o.motion),o.keyTimes&&(a.keyTimes=o.keyTimes),a.dur||(a.dur=this.overall.dur),a.keySplines||(a.keySplines=o.keySplines?o.keySplines:this.overall.keySplines);const c={step:a,data:o};i.push(c)}),i}},template:`
    <g :class="classList">
      <clipPath :id="clipPathId">
        <rect x="0" y="0" :width="width" :height="height" />
      </clipPath>
    ...
    </g>`}},Symbol.toStringTag,{value:"Module"})),js="0.3s",Os="7",P="0.2",be="shape-half-square",Es=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:be,computed:{begin(){return this.start?this.start:js},backgroundSquareColor(){return this.backgroundColor?this.backgroundColor:"var(--color-blue-light)"},firstSquareColor(){return this.firstColor?this.firstColor:"var(--color-page-detail-shape)"},secondSquareColor(){return this.secondColor?this.secondColor:"var(--color-background)"},thirdSquareColor(){return this.thirdColor?this.thirdColor:"var(--color-primary-accent)"},squareGroup(){return this.sequence.squareGroup},firstSquare(){return this.sequence.firstSquare},secondSquare(){return this.sequence.secondSquare},thirdSquare(){return this.sequence.thirdSquare},fourthSquare(){return this.sequence.fourthSquare},overall(){return{keySplines:"0 0 1 1",dur:"0.8s"}},width(){return 400},height(){return this.width},clipPathId(){var t;return`${(t=this.shapeElements)==null?void 0:t.getStepId("clip-path")}`},clipPathUrl(){return`clip-path: url(#${this.clipPathId});`},sequence(){var t;return(t=this.shapeElements)==null?void 0:t.getSequence()},shapeElements(){return this.shapeElementsInstance||(this.shapeElementsInstance=new D({tagName:be,elements:this.elements,begin:this.begin})),this.shapeElementsInstance}},data(){return{animations:[{steps:[{name:"transform1",from:"400",to:"200",dur:"",type:"translate"}]},{steps:[{name:"transform2",from:"200",to:"-80",dur:"",type:"translate"}]},{steps:[{name:"transform3",from:"-80",to:"-200",dur:"",type:"translate"}]},{steps:[{name:"transform4",from:"0",to:"-400",dur:"",type:"translate"}]},{steps:[{name:"animate",animate:!0,attributeName:"width",from:"300",to:"200",dur:"",type:"animate"}]}],elements:[{name:"squareGroup",transform1:{delay:P,start:!0,waitFor:"fourthSquare.reset",keySplines:"0.2, 0.8, 0.7, 1"},transform2:{delay:P,waitFor:"squareGroup.transform1",keySplines:"0.2, 0.7, 0.8, 1"},transform3:{delay:P,waitFor:"squareGroup.transform2",keySplines:"0.2, 0.7, 0.8, 1"},reset:{waitFor:"fourthSquare.transform4",delay:P,dur:"0.01s"}},{name:"secondSquare",animate:{delay:P,waitFor:"squareGroup.transform2",keySplines:"0.2, 0.8, 0.7, 1"},reset:{waitFor:"fourthSquare.transform4",delay:P,dur:"0.01s"}},{name:"fourthSquare",transform4:{delay:Os,waitFor:"squareGroup.transform3",keySplines:"0.2, 0.8, 0.7, 1"},reset:{waitFor:"fourthSquare.transform4",delay:P,dur:"0.1s"}}],shapeElementsInstance:null}},props:{backgroundColor:String,firstColor:String,secondColor:String,thirdColor:String,start:String},methods:{getStepData(t,e){const s=this.sequence[t];if(!s)return;const i=[];return e.forEach(r=>{const a={...r},o=s[a==null?void 0:a.name];if(!o)return;o.href=s.href,o.by&&(a.by=o.by),o.from&&(a.from=o.from),o.to&&(a.to=o.to),o.additive&&(a.additive=o.additive),o.dur&&(a.dur=o.dur),o.motion&&(a.motion=o.motion),o.animate&&(a.animate=o.animate),o.keyTimes&&(a.keyTimes=o.keyTimes),a.dur||(a.dur=this.overall.dur),a.keySplines||(a.keySplines=o.keySplines?o.keySplines:this.overall.keySplines);const c={step:a,data:o};i.push(c)}),i}},template:`
    <g :class="classList">
      <clipPath :id="clipPathId">
        <rect x="0" y="0" :width="width" :height="height" />
      </clipPath>
    ...
    </g>`}},Symbol.toStringTag,{value:"Module"})),Ps="0s",ne="0s",le="0.01s",ye="shape-moving-eye",Ns=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:ye,computed:{begin(){return this.start?this.start:Ps},squareColor(){return this.backgroundColor?this.backgroundColor:"var(--color-green-blue)"},circleColor(){return this.firstColor?this.firstColor:"var(--color-yellow)"},upperSquare(){return this.sequence.upperSquare},bottomSquare(){return this.sequence.bottomSquare},eyeCircle(){return this.sequence.eyeCircle},overall(){return{keySplines:"0 0 1 1",dur:"20s"}},width(){return 400},height(){return this.width},clipPathId(){var t;return`${(t=this.shapeElements)==null?void 0:t.getStepId("clip-path")}`},clipPathUrl(){return`clip-path: url(#${this.clipPathId});`},sequence(){var t;return(t=this.shapeElements)==null?void 0:t.getSequence()},shapeElements(){return this.shapeElementsInstance||(this.shapeElementsInstance=new D({tagName:ye,elements:this.elements,begin:this.begin})),this.shapeElementsInstance}},data(){return{animations:[{steps:[{name:"motion",attributeName:"motion",motion:!0}]},{steps:[{name:"transform",from:"1.3 1.01",to:"1.3 1.01",dur:"",type:"scale"}]}],elements:[{name:"upperSquare",transform:{start:!0,delay:0,values:"1.3 1.01;1.3 1.01;1.29756 0.5;1.3 1.01015;1.3 1.01;1.3 0.5;1.3 1.01;1.3 1.01;1.3 1.01",keyTimes:"0;0.0133333;0.0511111;0.0833333;0.1166667;0.1522222;0.1855555;0.2144444;1",keySplines:"0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0 0 0 0",additive:!0,waitFor:"eyeCircle.reset"},reset:{waitFor:"eyeCircle.motion",delay:ne,dur:le}},{name:"bottomSquare",transform:{start:!0,delay:0,values:"1.3 1.01;1.3 1.01;1.29756 0.5;1.3 1.01015;1.3 1.01;1.3 0.5;1.3 1.01;1.3 1.01;1.3 1.01",keyTimes:"0;0.0133333;0.0511111;0.0833333;0.1166667;0.1522222;0.1855555;0.2144444;1",keySplines:"0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0 0 0 0",additive:!0,waitFor:"eyeCircle.reset"},reset:{waitFor:"eyeCircle.motion",delay:ne,dur:le}},{name:"eyeCircle",motion:{start:!0,delay:0,keyTimes:"0;0.0133333;0.0511111;0.0833333;0.1166667;0.1522222;0.1855555;0.2144444;1",keySplines:"0.167 0.167 0.833 0.833;0.167 0.167 0.833 0.833;0.333 0 0.667 1;0.167 0.167 0.833 0.833;0.333 0 0.667 1;0.167 0.167 0.833 0.833;0.167 0.167 0.667 1;0 0 0 0",path:"M 263 168 C 263 168 263 168 263 168 C 237 167 109 167 109 167 C 109 167 212 167 263 168 C 283 168 239 168 263 168 C 296 167 397 168 412 168 C 436 168 287 168 263 168 C 238 168 263 168 263 168 C 263 168 263 168 263 168",keyPoints:"0;0;0.23;0.47;0.51;0.73;0.97;1;1",waitFor:"eyeCircle.reset"},reset:{waitFor:"eyeCircle.motion",delay:ne,dur:le}}],shapeElementsInstance:null}},props:{backgroundColor:String,firstColor:String,start:String},methods:{getStepData(t,e){const s=this.sequence[t];if(!s)return;const i=[];return e.forEach(r=>{const a={...r},o=s[a==null?void 0:a.name];if(!o)return;o.href=s.href,o.by&&(a.by=o.by),o.from&&(a.from=o.from),o.to&&(a.to=o.to),o.additive&&(a.additive=o.additive),o.dur&&(a.dur=o.dur),o.motion&&(a.motion=o.motion),o.keyTimes&&(a.keyTimes=o.keyTimes),a.dur||(a.dur=this.overall.dur),a.keySplines||(a.keySplines=o.keySplines?o.keySplines:this.overall.keySplines);const c={step:a,data:o};i.push(c)}),i}},template:`
    <g :class="classList">
      <clipPath :id="clipPathId">
        <rect x="0" y="0" :width="width" :height="height" />
      </clipPath>
    ...
    </g>`}},Symbol.toStringTag,{value:"Module"})),As="1s",_e="shape-security-eye",Is=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:_e,computed:{classList(){return["shape-square-forward","vue-component"]},begin(){return this.start?this.start:As},overall(){return{dur:"10s",sonarDelay:"9"}},internalWidth(){return this.width?this.width:400},internalHeight(){return this.internalWidth},halfWidth(){return this.internalWidth/2},halfHeight(){return this.internalHeight/2},clipPathId(){var t;return`${(t=this.shapeElements)==null?void 0:t.getStepId("clip-path")}`},clipPathUrl(){return`clip-path: url(#${this.clipPathId});`},sequence(){var t;return(t=this.shapeElements)==null?void 0:t.getSequence()},shapeElements(){return this.shapeElementsInstance||(this.shapeElementsInstance=new D({tagName:_e,elements:this.elements,begin:this.begin})),this.shapeElementsInstance}},data(){return{}},props:{backgroundColor:String,firstColor:String,secondColor:String,start:String,width:String},methods:{leftUpperSonarBegin(t){let e=8.44;return e=t?e+t/100:e,`${e}s;leftUpperSonarStep1.end+${this.overall.sonarDelay}s`},leftBottomSonarBegin(t){let e=5.5;return e=t?e+t/100:e,`${e}s;leftBottomSonarStep1.end+${this.overall.sonarDelay}s`},rightBottomSonarBegin(t){let e=2.5;return e=t?e+t/100:e,`${e}s;rightBottomSonarStep1.end+${this.overall.sonarDelay}s`},rightUpperSonarBegin(t){let e=.2;return e=t?e+t/100:e,`${e}s;rightUpperSonarStep1.end+${this.overall.sonarDelay}s`}},template:`
    <g :class="classList">
      <clipPath :id="clipPathId">
        <rect x="0" y="0" :width="internalWidth" :height="internalHeight" />
      </clipPath>
    ...
    </g>`}},Symbol.toStringTag,{value:"Module"})),$s="0s",qs="6s",V="0.05s",Se="shape-semi-circle",zs=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:Se,computed:{begin(){return this.start?this.start:$s},squareColor(){return this.backgroundColor?this.backgroundColor:"var(--color-green-blue)"},circleColor(){return this.firstColor?this.firstColor:"var(--color-yellow)"},semiCircle(){return this.sequence.semiCircle},resetSquare(){return this.sequence.resetSquare},overall(){return{keySplines:"0 0 1 1",dur:"1s"}},width(){return 400},height(){return this.width},clipPathId(){var t;return`${(t=this.shapeElements)==null?void 0:t.getStepId("clip-path")}`},clipPathUrl(){return`clip-path: url(#${this.clipPathId});`},sequence(){var t;return(t=this.shapeElements)==null?void 0:t.getSequence()},shapeElements(){return this.shapeElementsInstance||(this.shapeElementsInstance=new D({tagName:Se,elements:this.elements,begin:this.begin})),this.shapeElementsInstance}},data(){return{animations:[{steps:[{name:"moveTo1",from:"700 -300",to:"350 50",dur:"",type:"translate"}]},{steps:[{name:"moveTo2",from:"350 50",to:"50 350",dur:"",type:"translate"}]},{steps:[{name:"moveTo3",from:"50 350",to:"-300 700",dur:"",type:"translate"}]},{steps:[{name:"moveTo4",from:"400 0",to:"0 0",dur:"",type:"translate"}]}],elements:[{name:"semiCircle",moveTo1:{start:!0,delay:qs,keySplines:"0.5, 0.6, 0.8, 1",waitFor:"resetSquare.reset"},moveTo2:{delay:V,keySplines:"0.5, 0.7, 0.8, 1",waitFor:"semiCircle.moveTo1"},moveTo3:{delay:V,waitFor:"semiCircle.moveTo2"},reset:{waitFor:"resetSquare.moveTo4",delay:V,dur:V}},{name:"resetSquare",moveTo4:{delay:V,waitFor:"semiCircle.moveTo3"},reset:{waitFor:"resetSquare.moveTo4",delay:"1s",dur:V}}],shapeElementsInstance:null}},props:{backgroundColor:String,firstColor:String,start:String},methods:{getStepData(t,e){const s=this.sequence[t];if(!s)return;const i=[];return e.forEach(r=>{const a={...r},o=s[a==null?void 0:a.name];if(!o)return;o.href=s.href,o.by&&(a.by=o.by),o.from&&(a.from=o.from),o.to&&(a.to=o.to),o.additive&&(a.additive=o.additive),o.dur&&(a.dur=o.dur),o.motion&&(a.motion=o.motion),o.keyTimes&&(a.keyTimes=o.keyTimes),a.dur||(a.dur=this.overall.dur),a.keySplines||(a.keySplines=o.keySplines?o.keySplines:this.overall.keySplines);const c={step:a,data:o};i.push(c)}),i}},template:`
    <g :class="classList">
      <clipPath :id="clipPathId">
        <rect x="0" y="0" :width="width" :height="height" />
      </clipPath>
    ...
    <g :class="classList">
      ...
      <g :style="clipPathUrl">
        ...
        <circle :fill="circleColor" :id="bigCircle?.id" cx="200" cy="200" r="${A}">
          <animate
          ...
          <animate
            ...
            values="0;${A/1.1};${A/1.15};${A/1.1};${A}"
          />
        </circle>
        <circle :fill="rectColor" :id="smallCircle?.id" cx="200" cy="200" r="${N}">
          <animate
          ...
          <animate
            ...
            fill="freeze"
            keyTimes="0; 0.35; 0.70; 0.85; 1"
            values="0;${N/1.1};${N/1.15};${N/1.1};${N}"
          />
        </circle>
      </g>
    </g>`},Rs=Object.freeze(Object.defineProperty({__proto__:null,default:Fs},Symbol.toStringTag,{value:"Module"})),Us="0s",K="6s",E="1s",ke="shape-triangles-to-center",Hs=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:ke,computed:{begin(){return this.start?this.start:Us},triangleUpperStaticColor(){return this.firstColor?this.firstColor:"var(--color-green-blue)"},triangleBottomStaticColor(){return this.firstColor?this.firstColor:"var(--color-green-blue)"},triangleLeftStaticColor(){return this.thirdColor?this.thirdColor:"var(--color-yellow)"},triangleRightStaticColor(){return this.thirdColor?this.thirdColor:"var(--color-yellow)"},triangleUpperFirstColor(){return this.secondColor?this.secondColor:"var(--color-white)"},triangleBottomFirstColor(){return this.secondColor?this.secondColor:"var(--color-white)"},triangleLeftFirstColor(){return this.firstColor?this.firstColor:"var(--color-green-blue)"},triangleRightFirstColor(){return this.firstColor?this.firstColor:"var(--color-green-blue)"},triangleUpperFirst(){return this.sequence.triangleUpperFirst},triangleBottomFirst(){return this.sequence.triangleBottomFirst},triangleLeftFirst(){return this.sequence.triangleLeftFirst},triangleRightFirst(){return this.sequence.triangleRightFirst},overall(){return{keySplines:"0 0 1 1",dur:"1s"}},width(){return 400},height(){return this.width},clipPathId(){var t;return`${(t=this.shapeElements)==null?void 0:t.getStepId("clip-path")}`},clipPathUrl(){return`clip-path: url(#${this.clipPathId});`},sequence(){var t;return(t=this.shapeElements)==null?void 0:t.getSequence()},shapeElements(){return this.shapeElementsInstance||(this.shapeElementsInstance=new D({tagName:ke,elements:this.elements,begin:this.begin})),this.shapeElementsInstance}},data(){return{animations:[{steps:[{name:"moveTo1",from:"0 -200",to:"0 0",dur:"",type:"translate"}]},{steps:[{name:"moveTo2",from:"0 400",to:"0 200",dur:"",type:"translate"}]},{steps:[{name:"moveTo3",from:"-200 0",to:"0 0",dur:"",type:"translate"}]},{steps:[{name:"moveTo4",from:"400 0",to:"200 0",dur:"",type:"translate"}]}],elements:[{name:"triangleUpperFirst",moveTo1:{delay:E,start:!0,waitFor:"triangleUpperFirst.reset"},reset:{waitFor:"triangleUpperFirst.moveTo1",delay:K,dur:E}},{name:"triangleBottomFirst",moveTo2:{delay:E,start:!0,waitFor:"triangleBottomFirst.reset"},reset:{waitFor:"triangleBottomFirst.moveTo2",delay:K,dur:E}},{name:"triangleLeftFirst",moveTo3:{delay:E,start:!0,waitFor:"triangleLeftFirst.reset"},reset:{waitFor:"triangleLeftFirst.moveTo3",delay:K,dur:E}},{name:"triangleRightFirst",moveTo4:{delay:E,start:!0,waitFor:"triangleRightFirst.reset"},reset:{waitFor:"triangleRightFirst.moveTo4",delay:K,dur:E}}],shapeElementsInstance:null}},props:{firstColor:String,secondColor:String,thirdColor:String,start:String},methods:{getStepData(t,e){const s=this.sequence[t];if(!s)return;const i=[];return e.forEach(r=>{const a={...r},o=s[a==null?void 0:a.name];if(!o)return;o.href=s.href,o.by&&(a.by=o.by),o.from&&(a.from=o.from),o.to&&(a.to=o.to),o.additive&&(a.additive=o.additive),o.dur&&(a.dur=o.dur),o.motion&&(a.motion=o.motion),o.keyTimes&&(a.keyTimes=o.keyTimes),a.dur||(a.dur=this.overall.dur),a.keySplines||(a.keySplines=o.keySplines?o.keySplines:this.overall.keySplines);const c={step:a,data:o};i.push(c)}),i}},template:`
    <g :class="classList">
      <clipPath :id="clipPathId">
        <rect x="0" y="0" :width="width" :height="height" />
      </clipPath>
    ...
    </g>`}},Symbol.toStringTag,{value:"Module"})),Gs=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"shape",computed:{classList(){return["shape","vue-component"]},shapeName(){return this.name?this.name:"s-block"}},methods:{},props:{name:String,shapes:Array},template:`
    <div :class="classList">
      <div class="shape__container">
        <component :is="shapeName" :shapes="shapes" ></component>
      </div>
    </div>`}},Symbol.toStringTag,{value:"Module"})),we="l-block",Ws=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:we,computed:{name(){return we},secondShapeBackgroundColor(){return this.secondShape.backgroundColor?this.secondShape.backgroundColor:"var(--color-yellow)"},secondShapeFirstColor(){return this.secondShape.firstColor?this.secondShape.firstColor:"var(--color-orange)"},secondShapeSecondColor(){return this.secondShape.secondColor?this.secondShape.secondColor:"var(--color-white)"},firstShape(){return this.getShapeData(0)},secondShape(){return this.getShapeData(1)},thirdShape(){return this.getShapeData(2)},fourthShape(){return this.getShapeData(3)},classList(){return["l-block","vue-component"]},shapeWidth(){return 400},shapeHeight(){return this.shapeWidth}},methods:{allProps(t){const e={};for(const s of Object.keys(t))e[s]=t[s];return e},getShapeData(t){const e=(this.shapes&&this.shapes[t])??{};return this.allProps(e)},defaultComponent(t){switch(t){default:case 0:return"shape-moving-eye";case 1:return"rect";case 2:return"shape-semi-circle";case 3:return"shape-half-square"}}},props:{shapes:Array,backgroundColor:String,firstColor:String,secondColor:String},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),xe="square",Zs=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:xe,computed:{name(){return xe},allProps(){const t={};t.width=this.shapeWidth;for(const e of Object.keys(this.shape))t[e]=this.shape[e];return t},shape(){return this.shapes?this.shapes[0]:null},classList(){return["square","vue-component"]},shapeWidth(){return 400},shapeHeight(){return this.shapeWidth},viewBox(){return`0 0 ${this.shapeWidth} ${this.shapeHeight}`}},props:{shapes:Array},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),Te=({length:t,centerPadding:e})=>({slidesToShow:3,slidesToScroll:3,prevArrow:'<span class="slick__arrow-left rounded-circle"></span>',nextArrow:'<span class="slick__arrow-right rounded-circle"></span>',dots:t>3,centerMode:!1,dotsClass:"slick-pagination is-default",responsive:[{breakpoint:1200,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:992,settings:{centerMode:!0,infinite:!1,centerPadding:e||"30px",slidesToShow:2,slidesToScroll:2,dots:t>2}},{breakpoint:576,settings:{centerMode:!0,infinite:!1,centerPadding:e||"20px",slidesToShow:1,slidesToScroll:1,dots:t>1}}]}),Xs=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"slider",computed:{classList(){return["slider",`${n.isTrue(this.hideContainer)===!0?"":this.getSpacing}`,`${this.backgroundClass}`,"vue-component"]},jsonOptions(){return n.getJSON(this.options)},getSpacing(){return this.spacing?this.spacing:""},headlineLevelValue(){return this.headlineLevel?this.headlineLevel:"h3"},headlineClassesValue(){return`slider__headline ${this.headlineClasses?this.headlineClasses:"h3-font-size"}`},centerPaddingValue(){return this.centerPadding?this.centerPadding+"px":null},carouselOptions(){const t=this.childrenLength;if(t===0)return null;const e=this.jsonOptions?this.jsonOptions:Te({length:t,centerPadding:this.centerPaddingValue});return this.jsonOptions||(e.slidesToShow=e.slidesToScroll=1,e.dots=!0,e.responsive.forEach(i=>{i.settings.dots=!0,i.settings.slidesToScroll=i.settings.slidesToShow=1})),JSON.stringify(e)},childrenLength(){var t;return((t=this.children)==null?void 0:t.length)||0},children(){return this.$slots.default()},hideBackgroundValue(){return n.isTrue(this.hideBackground)},hideContainerValue(){return n.isTrue(this.hideContainer)},backgroundClass(){return this.hideBackgroundValue===!1?l.HAS_BACKGROUND:""},backgroundColor(){return this.bgColor?this.bgColor:this.defaultBgColor},style(){if(!this.hideBackgroundValue)return{"background-color":this.backgroundColor}}},data(){return{defaultBgColor:"var(--color-bg-grey)"}},props:{headline:String,headlineLevel:String,headlineClasses:String,spacing:String,hideContainer:{default:!1},hideBackground:{default:!1},bgColor:String,centerPadding:Number,options:Object},template:`
    <div :class="classList">
    ...
    </div>`},defaultOptions:Te},Symbol.toStringTag,{value:"Module"})),Ys=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"slot-items",props:{items:{default:[]}},render(){const t=this.items(),e=[];return t.forEach((s,i)=>{var r;(r=s==null?void 0:s.props)!=null&&r.style||(s.props.style=`--utility-animation-index: ${i+1}`),e.push(s)}),e}}},Symbol.toStringTag,{value:"Module"})),Qs=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"socials",data(){return{follow:""}},computed:{classValue(){return["socials align-items-center",n.isTrue(this.expand)?this.showLabel?"socials--label-expand":"socials--expand":"",n.isTrue(this.vertical)?"is-vertical-xl mr-5 mr-xl-0 align-items-xl-start mb-xl-4":"","vue-component"]},iconClasses(){return[n.isTrue(this.vertical)?"mb-5 mr-xl-0":""]},showLabel(){return!n.isTrue(this.label)},socialItemClass(){return["socials__item",this.iconClasses]},getList(){var c,d;const t="https://www.twitter.com/",e="https://www.linkedin.com/in/",s=["mailto:?subject=","https://www.linkedin.com/shareArticle?mini=true&url=","https://twitter.com/intent/tweet?text=&url="],i={email:"fas fa-envelope",linkedin:"fab fa-linkedin",twitter:"fab fa-x-twitter"},a=[{link:(c=this.author)!=null&&c.twitter?t+this.author.twitter:"",icon:i.twitter},{link:(d=this.author)!=null&&d.linkedin?e+this.author.linkedin:"",icon:i.linkedin}].filter(h=>h.link!=="");if(a.length>0)return a;const o=s.map(h=>h+this.shareUrl);return o==null?void 0:o.map((h,u)=>{const y=Object.keys(i)[u];return{link:h,icon:i[y]}})}},mounted(){var t,e;(e=(t=window.i18n)==null?void 0:t.loader)==null||e.then(()=>{var s;this.follow=(s=window.i18n)==null?void 0:s.translate("follow")})},methods:{},props:{label:String,author:{default:null},vertical:{default:null},expand:{default:null},shareUrl:{default:null}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),ei=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"tab-list",data(){return{smallVariant:"tab-list--small",showLeftArrow:!1,showRightArrow:!1,currentIndex:0,currentTabId:""}},mounted(){this.handleScroll(),this.currentTabId=this.list[0].id},computed:{leftValue(){return n.isTrue(this.left)===!0},columnClassList(){const s="col-"+(this.tabs?"":"lg-")+12/this.list.length;return[this.tabs?"px-2 px-lg-3 nav-item":"mb-6 mb-md-8 mb-lg-0",this.isSmall?"":s]},variantClass(){return this.variant?this.variant:this.smallVariant},classList(){return["tab-list vue-component",this.tabs?"px-4 px-lg-0":"",this.leftValue?"tab-list--left":"",this.variantClass,this.showLeftArrow?"show-left-arrow":"",this.showRightArrow?"show-right-arrow":""]},listClassList(){return["tab-list__list row nav nav-pills"]},isSmall(){return this.variantClass===this.smallVariant},hideContainer(){return!this.leftValue}},methods:{canScrollLeft(){const t=this.$refs.tabList;if(t)return t.scrollLeft>0},canScrollRight(){const t=this.$refs.tabList;if(t)return t.scrollLeft+t.clientWidth<t.scrollWidth-2},tabClassList(t){return["tab-list__tab rounded",t===this.currentIndex?"active":""]},ariaSelected(t){return t===this.currentIndex},boxClassList(t){return["tab-list__box rounded",t.link?"":"bg-white shadow-lg"]},isLink(t){return t.link?t.link.href:null},linkAttributes(t,e){const s={};return t.link&&Object.assign(s,{href:t.link.href,target:t.link.target}),t.id&&Object.assign(s,{id:t.id+"-tab","data-toggle":"pill",role:"tab","aria-controls":t.id,"aria-selected":this.ariaSelected(e)}),s},handleContentSwitch(t){const e=document.getElementById(t);if(!e)return;const s=document.getElementById(this.currentTabId);s.classList.remove("active"),s.classList.remove("show"),e.classList.add("active"),setTimeout(()=>{e.classList.add("show")},50),this.currentTabId=t},handleClick(t){t.preventDefault(),t.stopImmediatePropagation();const e=t.currentTarget;if(!e.href)return;const s=e.href.split("#")[1],i=document.getElementById(s),r=Array.prototype.indexOf.call(this.$refs.tabLink,e);this.currentIndex=r,i!==null&&(document.dispatchEvent(new CustomEvent(f.REFRESH_ANIMATE_NUMBERS,{detail:{target:i}})),this.handleContentSwitch(s))},handleScroll(){this.showLeftArrow=this.canScrollLeft(),this.showRightArrow=this.canScrollRight()},getArrowOffset(){const t=this.$refs.left;return t?t.offsetWidth:0},scrollToTab(t){const e=this.$refs.tabList,s=this.$refs.tab[this.currentIndex];if(!e||!s)return;const i=this.$refs.tab[t];if(!i)return;const r=this.getArrowOffset(),a=i.offsetLeft-r;e.scrollLeft=t===0?0:a,i.querySelector("a").click()},scrollToNext(){this.scrollToTab(this.currentIndex+1)},scrollToPrevious(){this.scrollToTab(this.currentIndex-1)}},props:{list:Array,tabs:Boolean,left:{default:null},variant:String},template:`
    <div :class="classList">
  ...
  `}},Symbol.toStringTag,{value:"Module"})),ti=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"tag",data(){return n.validateVueProps(this)},computed:{lowerLang(){return this.lang.toLowerCase()},classList(){var t;return["tags__btn btn btn-xs btn-soft-secondary btn-pill mb-2 vue-component",this.variant?"tag--"+this.variant:`mx-sm-${(t=this.props)==null?void 0:t.spacing}`,this.classes?this.classes:null]},url(){return this.lowerLang==="de"?"":`index-${this.lowerLang}/`},href(){return"/blog/"+this.url+"#"+encodeURIComponent(this.tag)},hasIcon(){return this.variant==="icon"}},props:{tag:{type:String,required:!0},count:{type:Number,default:null},filter:{type:Boolean,default:!1},lang:{type:String,default:"de"},spacing:{type:Number,default:1},classes:{type:String,default:null},variant:{type:String,default:null}},template:`
    <a
      :class="classList"
  ...
  `}},Symbol.toStringTag,{value:"Module"})),si=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"testimonial-list",template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"})),oi=Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"timeline",components:{"timeline-entry-inner-text":{tagName:"timeline-entry-inner-text",computed:{},template:`
...
`)},isGif(){return this.img?this.img.split(".")[1].toLowerCase()==="gif":void 0},isSvg(){var e;return n.getExtension(this.getCloudinaryBasePathLink()).toLowerCase()==="svg"||((e=this.img)==null?void 0:e.indexOf(".svg"))!==-1}},props:{imgSrcSets:{type:String,default:null},img:String,alt:String,cloudinary:Boolean,crossorigin:String,lazy:Boolean,class:String,preset:String,lottie:Object,lottieSettings:Object,animated:Boolean},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"}));class di{static getEmbedSrc(e,s){const i=encodeURIComponent(document.location.origin),r=encodeURIComponent(document.location.href);return`https://www.youtube-nocookie.com/embed/${e}?origin=${i}&autoplay=${s}&widget_referrer=${r}&enablejsapi=1&widgetid=1`}}const Me=Object.assign({"./components/accordion.js":Oe,"./components/ad-block-info.js":Ne,"./components/aside-wrapper.js":Ae,"./components/author-avatar.js":Ie,"./components/author-header.js":$e,"./components/authors.js":qe,"./components/blog-recent.js":ze,"./components/card.js":Be,"./components/carousel.js":Ve,"./components/check-card.js":Fe,"./components/content-scroller.js":Re,"./components/cta-list.js":Ue,"./components/cta.js":He,"./components/dropdown.js":Ge,"./components/event-overview.js":We,"./components/event.js":Je,"./components/fab-hint.js":Ze,"./components/faq.js":Ke,"./components/feature-grid-item.js":Xe,"./components/feature-list.js":Ye,"./components/filter-bar.js":Qe,"./components/footer.js":et,"./components/form-attachments.js":tt,"./components/form-checkbox.js":st,"./components/form-checkboxes.js":it,"./components/form-fields.js":at,"./components/form-radio.js":rt,"./components/form-radios.js":ot,"./components/form-select.js":nt,"./components/form.js":lt,"./components/google-map-entry.js":ct,"./components/google-map.js":dt,"./components/grid-list.js":ht,"./components/grid.js":pt,"./components/header.js":ut,"./components/headline.vue":vt,"./components/hero.js":bt,"./components/icon.js":yt,"./components/icons/arrow-curl.js":_t,"./components/icons/arrow-external.js":St,"./components/icons/arrow-narrow.js":Ct,"./components/icons/arrow.js":kt,"./components/icons/bin.js":wt,"./components/icons/check-mark.js":Dt,"./components/icons/check.js":xt,"./components/icons/close.js":Tt,"./components/icons/computer-shield.js":Mt,"./components/icons/email-action-unread.js":jt,"./components/icons/emergency.js":Ot,"./components/icons/expand.js":Et,"./components/icons/hand.js":Nt,"./components/icons/image-credits.js":At,"./components/icons/info.js":It,"./components/icons/list-view.js":$t,"./components/icons/magnifier.js":qt,"./components/icons/mail.js":zt,"./components/icons/meerkat.js":Bt,"./components/icons/menu.js":Vt,"./components/icons/minus.js":Ft,"./components/icons/phone-charger.js":Rt,"./components/icons/phone-mail.js":Ut,"./components/icons/phone.js":Ht,"./components/icons/pin.js":Gt,"./components/icons/plus-minus.js":Wt,"./components/icons/plus.js":Jt,"./components/icons/quotes.js":Zt,"./components/icons/rocket.js":Kt,"./components/icons/smile.js":Yt,"./components/icons/strategy-split.js":Qt,"./components/icons/tile-view.js":es,"./components/icons/world.js":ts,"./components/icons/x-mark.js":ss,"./components/image-block.js":is,"./components/image-list.js":as,"./components/img-filter.js":rs,"./components/job-list-detail.js":os,"./components/job-list-entry.js":ns,"./components/job-list.js":ls,"./components/letter-switcher.js":cs,"./components/link-list.js":ds,"./components/list-container.js":hs,"./components/logo-list.js":ps,"./components/lottie.js":us,"./components/modal.js":ms,"./components/person-quote.js":gs,"./components/post-teaser.js":fs,"./components/screenshot.js":vs,"./components/scroll-arrow.js":bs,"./components/search.js":ys,"./components/services.js":_s,"./components/shape-animation.js":Ss,"./components/shape-circle-within-square.js":ks,"./components/shape-fast-forward.js":Ds,"./components/shape-four-squares.js":Ls,"./components/shape-four-triangles.js":Ms,"./components/shape-half-square.js":Es,"./components/shape-moving-eye.js":Ns,"./components/shape-security-eye.js":Is,"./components/shape-semi-circle.js":zs,"./components/shape-square-circle.js":Rs,"./components/shape-triangles-to-center.js":Hs,"./components/shape.js":Gs,"./components/shapes/l-block.js":Ws,"./components/shapes/s-block.js":Js,"./components/shapes/square.js":Zs,"./components/shapes/t-block.js":Ks,"./components/slider.js":Xs,"./components/slot-items.js":Ys,"./components/socials.js":Qs,"./components/tab-list.js":ei,"./components/tag.js":ti,"./components/testimonial-list.js":si,"./components/text-animation.js":ii,"./components/text-icon-animation.js":ai,"./components/text-teaser.js":ri,"./components/timeline.js":oi,"./components/v-img.js":ci,"./components/video-inner.js":Object.freeze(Object.defineProperty({__proto__:null,default:{tagName:"video-inner",computed:{videoClass(){return["video utility-animation",`${this.videoParsed.id?"video--has-video":"hover__parent"}`,`${this.isVariantRow?"container":"d-flex flex-column"}`,`${n.isTrue(this.overlapping)?"video--is-overlapping":""}`,`${this.spacing?this.spacing:"space-bottom-1 space-bottom-lg-0"}`,`${this.isReversed()?"":"h-100"}`,`${this.variant?"video--"+this.variant:""}`,"vue-component"]},videoPlayerClass(){return["video__player fade-in-bottom",`${this.variantClasses}`,`${this.isPlayed?"video-player-played is-starting":""}`,`${this.videoParsed.ctaText?"video__player--has-link":""}`,"vue-component"]},videoContentClass(){const t=this.isReversed()?"pb-4":"py-4 px-3 p-lg-5";return["video__content fade-in-bottom",`${this.videoParsed.ctaText?"hover__parent":""}`,`${this.isVariantRow?"col-md-6 ":"flex-grow-1 "+t}`]},variantClasses(){return this.variant?this.isVariantRow?"col-md-6 order-md-2":"":"bg-dark"},isVariantRow(){return this.variant==="row"},videoParsed(){return typeof this.video!="object"?JSON.parse(this.video):this.video},onClickVideoContent(){return this.videoParsed.ctaText?"this.querySelector('a').click()":null},onClick(){return this.videoParsed.ctaText&&this.videoParsed.id?"this.querySelector('a').click()":null},videoId(){return"video-id__"+this.videoParsed.id},videoFrameId(){return this.videoId+"-frame"},headlineClasses(){return`h4-font-size ${this.isVariantRow?"mb-0":""}`},dataOptionsLightBox(){const t={selector:`#${this.videoId} .js-video-button`,speed:700,buttons:["fullScreen","close"],media:{youtube:{url:"https://www.youtube-nocookie.com/embed/$4",params:{autoplay:1}}}};return JSON.stringify(t)},options(){return{videoId:this.videoParsed.id,parentSelector:"#"+this.videoId,targetSelector:"#"+this.videoFrameId,isAutoplay:!0}},dataOptionsRegular(){return JSON.stringify(this.options)},dataSrc(){return"https://www.youtube-nocookie.com/"+this.videoParsed.id},embedSrc(){return di.getEmbedSrc(this.videoParsed.id,this.options.isAutoplay)},dataCaption(){return this.videoParsed.headline}},mounted(){var t,e,s;(s=(e=(t=$==null?void 0:$.HSCore)==null?void 0:t.components)==null?void 0:e.HSFancyBox)==null||s.init($(this.$refs.lightbox))},methods:{isReversed(){return this.variant==="reversed"},handleButtonClick(){this.isPlayed=!0},handleClose(){this.isPlayed=!1}},data(){return{isPlayed:!1}},props:{video:Object,variant:String,spacing:String,overlapping:String,level:{default:"h4"}},template:`
  ...
  `}},Symbol.toStringTag,{value:"Module"}))}),je={};for(const t in Me){const e=t.split("/").pop().replace(/\.\w+$/,"");je[e]=g.defineAsyncComponent(()=>Promise.resolve(Me[t]))}return je});
