export default {
  ...
  <div class="form__radio-control mb-1 vue-component">
    <template v-if="radio?.placeholder">
      ...
      <input class="" type="text" :name="idValue" :id="idValue" :placeholder="radio?.placeholder" :data-form-group="group">
    </template>
    <template v-else>
      <input class="form__radio" type="radio" :name="idValue" :id="idValue" :data-form-group="group" :required="required">
