const iconHandStepTime = 'indefinite';
const iconHandDuration = '1.5s';
const iconHandRepetition = '3';
...
export default {
  ...
  <svg v-bind="settings" :style="style" viewBox="0 0 308 304" fill="none">
    ...
    <animateTransform class="js-text-animation__step-1" href="#hand-outline" attributeName="transform" type="rotate"
      values="-17 187.5 192; 22 187.5 192; -17 187.5 192"
      begin="${iconHandStepTime}" dur="${iconHandDuration}" repeatCount="${iconHandRepetition}"
    />

    <animate class="js-text-animation__step-1" href="#inner-lines" attributeName="opacity"
      values="0.9; 0.05; 0.9"
      begin="${iconHandStepTime}" dur="${iconHandDuration}" repeatCount="${iconHandRepetition}"
    />

    <animate class="js-text-animation__step-1" href="#outter-lines" attributeName="opacity"
