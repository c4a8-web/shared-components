...
export default {
  ...
  computed: {
    ...
    squareColor() {
      return this.backgroundColor ? this.backgroundColor : '#fcd116';
    },
    triangleColor() {
      return this.firstColor ? this.firstColor : '#f8842c';
    },
    secondTriangleColor() {
      return this.secondColor ? this.secondColor : '#fff';
    },
    firstShape() {
  ...
  template: `
    <svg :class="classList" :data-name="name" viewBox="0 0 800 1200" width="800" height="1200">
      ...
      <g v-else>
        ...
        <path :fill="triangleColor" d="M 600 800 H 400 L 600 600 l 0 200 z"/>
        <path :fill="secondTriangleColor" d="m 800 800 l -200 -200 H 600 V 800 z"/>
        <path :fill="triangleColor" d="m 400 600 l 200 -200 H 600 V 600 z"/>
        <path :fill="secondTriangleColor" d="m 800 600 l -200 -200 H 600 V 600 z"/>
      </g>
