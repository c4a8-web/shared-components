  ...
  template: `
    <svg :class="classList" :data-name="name" viewBox="0 0 800 1200" width="800" height="1200">
      ...
      <g v-else transform="translate (-400 400)" >
        <path :fill="fourthShape?.backgroundColor" d="M 400 800 h 400 v -400 H 400 z"/>
        <path :fill="fourthShape?.leftTriangleColor" d="M 600 800 H 400 L 600 600 l 0 200 z"/>
        <path :fill="fourthShape?.rightTriangleColor" d="m 800 800 l -200 -200 H 600 V 800 z"/>
        <path :fill="fourthShape?.leftTriangleColor" d="m 400 600 l 200 -200 H 600 V 600 z"/>
        <path :fill="fourthShape?.rightTriangleColor" d="m 800 600 l -200 -200 H 600 V 600 z"/>
      </g>
